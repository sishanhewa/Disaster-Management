...
import { t as p$1 } from "./EditCircuitsResult-NncfukWH.js";
//#region node_modules/@arcgis/core/rest/networks/circuits/alterCircuit.js
async function p(p, u$1, e) {
	const m = f$1(p), a = {
		...u$1.toJSON(),
		f: "json"
	}, c = s(u({
		...
		method: "post",
		authMode: "no-prompt"
	}), { data: d } = await f(`${m.path}/circuits/alter`, c);
	return p$1.fromJSON(d);
}
//#endregion
export { p as alterCircuit };

//# sourceMappingURL=alterCircuit-BB6vYycX.js.map