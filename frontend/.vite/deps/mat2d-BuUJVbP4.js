...
//#region node_modules/@arcgis/core/core/libs/gl-matrix-2/math/mat2d.js
function n(t, n) {
...
function u(t, n) {
	const a = n[0], r = n[1], u = n[2], o = n[3], e = n[4], s = n[5];
	let c = a * o - r * u;
...
function e(t, n, a) {
	const r = n[0], u = n[1], o = n[2], e = n[3], s = n[4], c = n[5], i = a[0], M = a[1], h = a[2], f = a[3], b = a[4], l = a[5];
	return t[0] = r * i + o * M, t[1] = u * i + e * M, t[2] = r * h + o * f, t[3] = u * h + e * f, t[4] = r * b + o * l + s, t[5] = u * b + e * l + c, t;
}
function s(t, n, a) {
	const r = n[0], u = n[1], o = n[2], e = n[3], s = n[4], c = n[5], i = Math.sin(a), M = Math.cos(a);
	return t[0] = r * M + o * i, t[1] = u * M + e * i, t[2] = r * -i + o * M, t[3] = u * -i + e * M, t[4] = s, t[5] = c, t;
}
function c(t, n, a) {
	const r = n[0], u = n[1], o = n[2], e = n[3], s = n[4], c = n[5], i = a[0], M = a[1];
...
function S(n, a) {
	const r = n[0], u = n[1], o = n[2], e = n[3], s = n[4], c = n[5], i = a[0], M = a[1], h = a[2], f = a[3], b = a[4], l = a[5], m = e$1();
...
//#endregion
export { f as a, r as c, e as i, s as l, a as n, h as o, c as r, i as s, M as t, u };

//# sourceMappingURL=mat2d-BuUJVbP4.js.map