...
import { A as m, a as o, n as c$1, t as a } from "./decorators-DE7S5xmd.js";
...
//#region node_modules/@arcgis/core/rest/networks/circuits/support/ExportCircuitsResult.js
var c;
var u = c = class extends n {
	static from(r) {
		return m(c, r);
	}
	constructor(r) {
		super(r), this.circuits = null, this.moment = null, this.exceededTransferLimit = !1, this.serviceEdits = null;
	}
	readServiceEdits(r, e) {
		return t(r);
	}
};
__decorate([a({ json: { type: [Object] } })], u.prototype, "circuits", void 0), __decorate([a({ type: Date })], u.prototype, "moment", void 0), __decorate([a({
	type: Boolean,
	json: {
		type: Boolean,
		write: !0
	}
})], u.prototype, "exceededTransferLimit", void 0), __decorate([a({ type: [Object] })], u.prototype, "serviceEdits", void 0), __decorate([o("serviceEdits")], u.prototype, "readServiceEdits", null), u = c = __decorate([c$1("esri.rest.networks.circuits.support.ExportCircuitsResult")], u);
//#endregion
//#region node_modules/@arcgis/core/rest/networks/circuits/exportCircuits.js
async function i(i, u$2, e) {
	const m = f$1(i), a = {
		...u$2.toJSON(),
		f: "json"
	}, c = s(u$1({
		...
		method: "post",
		authMode: "no-prompt"
	}), { data: j } = await f(`${m.path}/circuits/export`, c);
	return u.fromJSON(j);
}
//#endregion
export { i as exportCircuits };

//# sourceMappingURL=exportCircuits-CAY31ozI.js.map