...
//#region node_modules/@arcgis/core/chunks/arcgis-knowledge-client-core-simd.js
function r(a, r) {
...
function n() {
	return t || (t = 1, a = e, r = globalThis.document?.currentScript?.src, n = async function(a = {}) {
		...
		var it, st, ut, ft, lt, ht, ct, wt, dt = { 212604: () => "undefined" != typeof wasmOffsetConverter }, vt = {
			U: function() {
		...
		return wt = await async function() {
			...
			}) : (g ??= e.locateFile ? e.locateFile("arcgis-knowledge-client-core-simd.wasm", o) : o + "arcgis-knowledge-client-core-simd.wasm", a((await j(r)).instance));
		}(), function() {
			function a() {
				if (e.calledRun = !0, !C) {
					var a, r;
...
//# sourceMappingURL=arcgis-knowledge-client-core-simd-ChlWyBQ7.js.map