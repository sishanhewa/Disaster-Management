...
//#region node_modules/@arcgis/core/support/basemapDefinitions.js
async function s(e) {
	if (!e) return;
	const s = e.includes("-vector") ? e.slice(0, e.indexOf("-vector")) : e.includes("-3d") ? e.slice(0, e.indexOf("-3d")) : e, a = await f("esri/t9n/basemaps");
	return a[e] || a[s];
}
var a = {
	satellite: {
	...
	terrain: {
		...
		baseMapLayers: [
			...
			{
				id: "terrain-base",
				styleUrl: "https://www.arcgis.com/sharing/rest/content/items/33064a20de0c48d2bb61efa8faca93a8/resources/styles/root.json",
				layerType: "VectorTileLayer",
				title: "World Terrain Base"
			},
			{
				id: "terrain-reference",
				styleUrl: "https://www.arcgis.com/sharing/rest/content/items/14fbc125ccc9488888b014db09f35f67/resources/styles/root.json",
				layerType: "VectorTileLayer",
				title: "World Reference Reference",
				isReference: !0
			}
		]
	},
	oceans: {
		...
		baseMapLayers: [{
			...
			styleUrl: "https://cdn.arcgis.com/sharing/rest/content/items/94329802cbfa44a18f423e6f1a0b875c/resources/styles/root.json",
			layerType: "VectorTileLayer",
		...
		baseMapLayers: [
			{
				...
				styleUrl: "https://cdn.arcgis.com/sharing/rest/content/items/d309c87e9f8c46a0af638d0533193e9b/resources/styles/root.json",
				layerType: "VectorTileLayer",
				title: "Topographic",
				visibility: !0,
				opacity: 1
		...
		baseMapLayers: [
			{
				...
				styleUrl: "https://cdn.arcgis.com/sharing/rest/content/items/dbcfc899c38945d5b42416329e31df2a/resources/styles/root.json",
				layerType: "VectorTileLayer",
				title: "Navigation",
				visibility: !0,
				opacity: 1
		...
		baseMapLayers: [
			{
				...
				styleUrl: "https://cdn.arcgis.com/sharing/rest/content/items/204b38a0b9b24b0fac373167db16c5cd/resources/styles/root.json",
				layerType: "VectorTileLayer",
				title: "Streets",
				visibility: !0,
				opacity: 1
		...
		baseMapLayers: [
			{
				...
				styleUrl: "https://cdn.arcgis.com/sharing/rest/content/items/4694cc30a67a434f80d09e557e74413d/resources/styles/root.json",
				layerType: "VectorTileLayer",
				title: "OpenStreetMap Style",
				visibility: !0,
				opacity: 1
			},
			{
		...
		baseMapLayers: [
			{
				...
				styleUrl: "https://cdn.arcgis.com/sharing/rest/content/items/75610658508d4d6e99298abaac8aff62/resources/styles/root.json",
				layerType: "VectorTileLayer",
	...
	"navigation-dark-3d": {
		...
		itemId: "84f9f68a3b6e4f68b09ddf9cdef8cb9f",
		is3d: !0,
		baseMapLayers: [
			{
				id: "navigation-dark-3d-base-layer",
				styleUrl: "https://cdn.arcgis.com/sharing/rest/content/items/6a8f24366a8b42abb2535d8f14777768/resources/styles/root.json",
				layerType: "VectorTileLayer",
			...
			},
			{
				...
				title: "Places and Labels",
				url: "https://basemaps3d.arcgis.com/arcgis/rest/services/Open3D_LightLabels_v1/SceneServer",
				layerType: "ArcGISSceneServiceLayer"
			},
			{
	...
	"streets-dark-3d": {
		id: "streets-dark-3d",
		itemId: "0281b25f75b24ca9b8835c6285cef9c2",
		is3d: !0,
		baseMapLayers: [
			{
				id: "streets-dark-3d-base-layer",
				styleUrl: "https://cdn.arcgis.com/sharing/rest/content/items/9a8a322ab26f412fa4c299039f441ad7/resources/styles/root.json",
				layerType: "VectorTileLayer",
				title: "Streets (Dark)"
			},
			{
	...
	"dark-gray-3d": {
		id: "dark-gray-3d",
		itemId: "da21f8d16bcd4bd392a06212e121de32",
		is3d: !0,
		baseMapLayers: [
			{
				id: "dark-gray-3d-base-layer",
				styleUrl: "https://cdn.arcgis.com/sharing/rest/content/items/e6b230fe483b43f390a7e767731d52d6/resources/styles/root.json",
				layerType: "VectorTileLayer",
...
//# sourceMappingURL=basemapDefinitions-CGK-Ctsz.js.map