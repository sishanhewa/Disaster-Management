...
//#endregion
//#region node_modules/@arcgis/core/core/sql/UnknownTimeZone.js
var e = class {
	static {
		this.instance = FixedOffsetZone.parseSpecifier("UTC");
	}
};
function i(n) {
	return n instanceof Zone ? n === e.instance : "unknown" === n?.toString().toLowerCase();
}
function o(n) {
	return i(n) ? e.instance : n;
}
//#endregion
export { FixedOffsetZone as a, DateTime as i, i as n, IANAZone as o, o as r, Zone as s, e as t };

//# sourceMappingURL=UnknownTimeZone-Dk-CZx5e.js.map