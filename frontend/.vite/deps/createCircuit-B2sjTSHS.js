...
//#region node_modules/@arcgis/core/rest/networks/circuits/createCircuit.js
async function e(e, p$1, u$1) {
	const m = f$1(e), a = {
		...p$1.toJSON(),
		f: "json"
	}, n = s(u({
		...
		method: "post",
		authMode: "no-prompt"
	}), { data: d } = await f(`${m.path}/circuits/create`, n);
	return p.fromJSON(d);
}
//#endregion
export { e as createCircuit };

//# sourceMappingURL=createCircuit-B2sjTSHS.js.map