...
//#region node_modules/@arcgis/core/rest/networks/unitIdentifiers/reset.js
async function i(i, n, p$1) {
	const f$2 = f$1(i), m = n.toJSON();
	...
	const u$1 = {
		...
		method: "post",
		authMode: "no-prompt"
	}), { data: d } = await f(`${f$2.path}/unitIdentifiers/reset`, c);
	return p.fromJSON(d);
}
//#endregion
export { i as reset };

//# sourceMappingURL=reset-P38y04rG.js.map