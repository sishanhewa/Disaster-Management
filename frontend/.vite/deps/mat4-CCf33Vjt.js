import { n as e$1 } from "./common-BxLRDsKd.js";
import { s as n$1 } from "./vec3f64-CwISzc_v.js";
//#region node_modules/@arcgis/core/core/libs/gl-matrix-2/math/mat4.js
function n(t, a) {
...
function s(t, a) {
	if (t === a) {
		const n = a[1], r = a[2], o = a[3], s = a[6], e = a[7], h = a[11];
...
function h(t, a) {
	const n = a[0], r = a[1], o = a[2], s = a[3], e = a[4], h = a[5], u = a[6], M = a[7], c = a[8], i = a[9], f = a[10], b = a[11], l = a[12], m = a[13], x = a[14], q = a[15], d = n * h - r * e, p = n * u - o * e, g = n * M - s * e, y = r * u - o * h, R = r * M - s * h, v = o * M - s * u, S = c * m - i * l, T = c * x - f * l, I = c * q - b * l, O = i * x - f * m, j = i * q - b * m, P = f * q - b * x;
...
function u(t, a) {
	const n = a[0], r = a[1], o = a[2], s = a[3], e = a[4], h = a[5], u = a[6], M = a[7], c = a[8], i = a[9], f = a[10], b = a[11], l = a[12], m = a[13], x = a[14], q = a[15];
...
function M(t) {
	const a = t[0], n = t[1], r = t[2], o = t[3], s = t[4], e = t[5], h = t[6], u = t[7], M = t[8], c = t[9], i = t[10], f = t[11], b = t[12], l = t[13], m = t[14], x = t[15];
	return (a * e - n * s) * (i * x - f * m) - (a * h - r * s) * (c * x - f * l) + (a * u - o * s) * (c * m - i * l) + (n * h - r * e) * (M * x - f * b) - (n * u - o * e) * (M * m - i * b) + (r * u - o * h) * (M * l - c * b);
}
function c(t, a, n) {
	const r = a[0], o = a[1], s = a[2], e = a[3], h = a[4], u = a[5], M = a[6], c = a[7], i = a[8], f = a[9], b = a[10], l = a[11], m = a[12], x = a[13], q = a[14], d = a[15];
	let p = n[0], g = n[1], y = n[2], R = n[3];
...
function i(t, a, n) {
	const r = n[0], o = n[1], s = n[2];
	if (a === t) t[12] = a[0] * r + a[4] * o + a[8] * s + a[12], t[13] = a[1] * r + a[5] * o + a[9] * s + a[13], t[14] = a[2] * r + a[6] * o + a[10] * s + a[14], t[15] = a[3] * r + a[7] * o + a[11] * s + a[15];
	else {
		const n = a[0], e = a[1], h = a[2], u = a[3], M = a[4], c = a[5], i = a[6], f = a[7], b = a[8], l = a[9], m = a[10], x = a[11];
...
function b(t, r, o, s) {
	let e = s[0], h = s[1], u = s[2], M = Math.sqrt(e * e + h * h + u * u);
	if (M <= e$1()) return void n(t, r);
	M = 1 / M, e *= M, h *= M, u *= M;
	const c = Math.sin(o), i = Math.cos(o), f = 1 - i, b = r[0], l = r[1], m = r[2], x = r[3], q = r[4], d = r[5], p = r[6], g = r[7], y = r[8], R = r[9], v = r[10], S = r[11], T = e * e * f + i, I = h * e * f + u * c, O = u * e * f - h * c, j = e * h * f - u * c, P = h * h * f + i, D = u * h * f + e * c, _ = e * u * f + h * c, A = h * u * f - e * c, w = u * u * f + i;
...
function l(t, a, n) {
	const r = Math.sin(n), o = Math.cos(n), s = a[4], e = a[5], h = a[6], u = a[7], M = a[8], c = a[9], i = a[10], f = a[11];
...
function m(t, a, n) {
	const r = Math.sin(n), o = Math.cos(n), s = a[0], e = a[1], h = a[2], u = a[3], M = a[8], c = a[9], i = a[10], f = a[11];
...
function x(t, a, n) {
	const r = Math.sin(n), o = Math.cos(n), s = a[0], e = a[1], h = a[2], u = a[3], M = a[4], c = a[5], i = a[6], f = a[7];
...
function p(t, n, r) {
	if (0 === n) return o(t);
	let s = r[0], e = r[1], h = r[2], u = Math.sqrt(s * s + e * e + h * h);
	if (u <= e$1()) return null;
	u = 1 / u, s *= u, e *= u, h *= u;
	const M = Math.sin(n), c = Math.cos(n), i = 1 - c;
...
function g(t, a) {
	const n = Math.sin(a), r = Math.cos(a);
...
function v(t, a, n) {
	const r = a[0], o = a[1], s = a[2], e = a[3], h = r + r, u = o + o, M = s + s, c = r * h, i = r * u, f = r * M, b = o * u, l = o * M, m = s * M, x = e * h, q = e * u, d = e * M;
...
function S(t, a) {
	const n = T, r = -a[0], o = -a[1], s = -a[2], e = a[3], h = a[4], u = a[5], M = a[6], c = a[7], i = r * r + o * o + s * s + e * e;
...
function O(t, a) {
	const n = a[0], r = a[1], o = a[2], s = a[4], e = a[5], h = a[6], u = a[8], M = a[9], c = a[10];
...
function P(t, a, n, r) {
	const o = a[0], s = a[1], e = a[2], h = a[3], u = o + o, M = s + s, c = e + e, i = o * u, f = o * M, b = o * c, l = s * M, m = s * c, x = e * c, q = h * u, d = h * M, p = h * c, g = r[0], y = r[1], R = r[2];
...
function D(t, a, n, r, o) {
	const s = a[0], e = a[1], h = a[2], u = a[3], M = s + s, c = e + e, i = h + h, f = s * M, b = s * c, l = s * i, m = e * c, x = e * i, q = h * i, d = u * M, p = u * c, g = u * i, y = r[0], R = r[1], v = r[2], S = o[0], T = o[1], I = o[2], O = (1 - (m + q)) * y, j = (b + g) * y, P = (l - p) * y, D = (b - g) * R, _ = (1 - (f + q)) * R, A = (x + d) * R, w = (l + p) * v, F = (x - d) * v, Q = (1 - (f + m)) * v;
...
function _(t, a) {
	const n = a[0], r = a[1], o = a[2], s = a[3], e = n + n, h = r + r, u = o + o, M = n * e, c = r * e, i = r * h, f = o * e, b = o * h, l = o * u, m = s * e, x = s * h, q = s * u;
...
function w(t, a, n, r, o) {
	...
	let e;
	return t[0] = s / n, t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[5] = s, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[11] = -1, t[12] = 0, t[13] = 0, t[15] = 0, null != o && o !== Infinity ? (e = 1 / (r - o), t[10] = (o + r) * e, t[14] = 2 * o * r * e) : (t[10] = -1, t[14] = -2 * r), t;
}
function F(t, a, n, r) {
	const o = Math.tan(a.upDegrees * Math.PI / 180), s = Math.tan(a.downDegrees * Math.PI / 180), e = Math.tan(a.leftDegrees * Math.PI / 180), h = Math.tan(a.rightDegrees * Math.PI / 180), u = 2 / (e + h), M = 2 / (o + s);
...
function Y(t, a, n, r) {
	const o = a[0], s = a[1], e = a[2], h = r[0], u = r[1], M = r[2];
	let c = o - n[0], i = s - n[1], f = e - n[2], b = c * c + i * i + f * f;
	b > 0 && (b = 1 / Math.sqrt(b), c *= b, i *= b, f *= b);
	let l = u * f - M * i, m = M * c - h * f, x = h * i - u * c;
...
function C(t, n) {
	if (t === n) return !0;
	const r = t[0], o = t[1], s = t[2], e = t[3], h = t[4], u = t[5], M = t[6], c = t[7], i = t[8], f = t[9], b = t[10], l = t[11], m = t[12], x = t[13], q = t[14], d = t[15], p = n[0], g = n[1], y = n[2], R = n[3], v = n[4], S = n[5], T = n[6], I = n[7], O = n[8], j = n[9], P = n[10], D = n[11], _ = n[12], A = n[13], w = n[14], F = n[15], Q = e$1();
...
function G(t) {
	const n = e$1(), r = t[0], o = t[1], s = t[2], e = t[4], h = t[5], u = t[6], M = t[8], c = t[9], i = t[10];
...
//#endregion
export { s as A, l as C, p as D, o as E, q as O, j as S, n as T, e as _, G as a, h as b, O as c, R as d, X as f, d as g, c as h, D as i, x as j, r as k, P as l, b as m, B as n, H as o, _ as p, C as r, I as s, A as t, Q as u, f as v, m as w, i as x, g as y };

//# sourceMappingURL=mat4-CCf33Vjt.js.map