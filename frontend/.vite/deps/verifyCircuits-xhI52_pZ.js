...
//#region node_modules/@arcgis/core/rest/networks/circuits/support/CircuitVerifyResult.js
var p = class extends n {
	constructor(r) {
		super(r), this.error = null, this.geometry = null, this.name = null;
	}
};
__decorate([a({ type: Object })], p.prototype, "error", void 0), __decorate([a({ type: y })], p.prototype, "geometry", void 0), __decorate([a({ type: String })], p.prototype, "name", void 0), p = __decorate([c$1("esri.rest.networks.circuits.support.CircuitVerifyResult")], p);
var i = p;
//#endregion
//#region node_modules/@arcgis/core/rest/networks/circuits/support/VerifyCircuitsResult.js
var c = class extends n {
	constructor(e) {
		super(e), this.circuits = [], this.moment = null, this.exceededTransferLimit = !1, this.serviceEdits = null;
	}
	readServiceEdits(e, t$1) {
		return t(e);
	}
};
__decorate([a({
...
})], c.prototype, "circuits", void 0), __decorate([a({
	type: Date,
	json: {
		type: Number,
		write: { writer: (e, t) => {
...
})], c.prototype, "exceededTransferLimit", void 0), __decorate([a({
	type: [Object],
	json: {
		type: [Object],
		write: !0
	}
})], c.prototype, "serviceEdits", void 0), __decorate([o("serviceEdits")], c.prototype, "readServiceEdits", null), c = __decorate([c$1("esri.rest.networks.circuits.support.VerifyCircuitsResult")], c);
//#endregion
//#region node_modules/@arcgis/core/rest/networks/circuits/verifyCircuits.js
async function e(e, p, u$1) {
	const m = f$1(e), f$2 = {
		...p.toJSON(),
		f: "json"
	}, n = s(u({
		...
		method: "post",
		authMode: "no-prompt"
	}), { data: j } = await f(`${m.path}/circuits/verify`, n);
	return c.fromJSON(j);
}
//#endregion
export { e as verifyCircuits };

//# sourceMappingURL=verifyCircuits-xhI52_pZ.js.map