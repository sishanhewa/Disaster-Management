...
import { r as Ke, t as Ge } from "./jsonConverter-C7YfydKv.js";
import "./FlatGeometry-LfXCi8BW.js";
import "./FlatGeometry-D0n_NdSI.js";
//#region node_modules/@arcgis/core/geometry/operators/json/lengthOperator.js
function n(n, e = {}) {
	const { unit: s } = e;
	let c = Ke(n).calculateLength2D();
	const u = Ge(n);
	return c && s && u && (c = O(c, u, s)), c;
}
//#endregion
export { n as execute };

//# sourceMappingURL=lengthOperator-CMUhtj-j.js.map