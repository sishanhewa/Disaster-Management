...
import { M as svg, N as css, O as html, d as setAttribute, j as nothing, l as safeClassMap, r as customElement, s as LitElement, u as safeStyleMap } from "./runtime-C8rHe43j.js";
import { t as guid } from "./guid-0rMdwY7J.js";
import { t as useT9n } from "./useT9n-ER3d4eMb.js";
//#region node_modules/@esri/calcite-components/dist/components/calcite-loader/customElement.js
var CSS = {
...
var Loader = class extends LitElement {
	constructor() {
		super(...arguments);
	...
	willUpdate(changes) {
		if (changes.has("value") && (this.hasUpdated || this.value !== 0)) this.valueChangeHandler();
		if (changes.has("type") && (this.hasUpdated || this.type !== "indeterminate") || changes.has("messages")) this.updateFormatter();
	}
	valueChangeHandler() {
		this.complete = this.type.startsWith("determinate") && this.value === 100;
	}
	formatValue() {
		if (this.type !== "determinate-value") return `${this.value}`;
	...
	updateFormatter() {
		if (this.type !== "determinate-value" || this.formatter?.resolvedOptions().locale === this.messages._lang) return;
		this.formatter = new Intl.NumberFormat(this.messages._lang, { style: "percent" });
	}
	render() {
...
//#endregion
//#region node_modules/@esri/calcite-components/dist/components/calcite-loader/index.js
var calcite_loader_exports = /* @__PURE__ */ __exportAll({ Loader: () => Loader });
//#endregion
export { calcite_loader_exports as t };

//# sourceMappingURL=calcite-loader-Bzm1Kkr9.js.map