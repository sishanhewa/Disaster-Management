...
//#region node_modules/@arcgis/core/rest/networks/unitIdentifiers/insertGap.js
async function e(e, n, p$1) {
	const m = f$1(e), u$1 = {
		...n.toJSON(),
		f: "json"
	}, f$2 = s(u({
		...
		method: "post",
		authMode: "no-prompt"
	}), { data: j } = await f(`${m.path}/unitIdentifiers/insertGap`, f$2);
	return p.fromJSON(j);
}
//#endregion
export { e as insertGap };

//# sourceMappingURL=insertGap-C9hvU9Ee.js.map