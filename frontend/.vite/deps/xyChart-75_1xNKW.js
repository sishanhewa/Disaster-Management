...
import { n as line_default, t as area_default } from "./area-Be1_Apvy.js";
import { $t as p50, At as keys, B as color, Bt as remove, D as fitToRange, Dt as each, Et as copy$1, F as ListTemplate, G as decimalPlaces, Gt as isNumber, Mt as each$1, N as List, P as ListAutoDispose, Qt as p100, Rt as move, T as ceil, Tt as MultiDisposer, U as capitalizeFirst, V as addEventListener, Vt as removeFirst, Wt as isNaN, X as getEventKey, Xt as Percent, a as populateString, ct as isTouchEvent, d as Graphics, en as percent, f as visualSettings, ft as relativeToValue, i as Container, j as round, jt as copy, lt as mergeTags, m as Template, mt as sameBounds, n as Label, st as isLocalEvent, t as Theme, u as Rectangle, v as compareNumber, yt as supports, z as Color } from "./Theme-kaw1IGF4.js";
import { n as setColor } from "./DefaultTheme-D93gZRcP.js";
import { n as RoundedRectangle, t as Button } from "./Button-CifN88BS.js";
import { a as Component, i as round$1, n as SerialChart, o as DataItem, r as Series, t as Tick } from "./Tick-CcwcFRd0.js";
import { t as ColorSet } from "./ColorSet-Ca5lcvrV.js";
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/XYChartDefaultTheme.js
/**
* @ignore
*/
	...
	setupDefaultRules() {
		...
		*/
		r("XYChart", ["scrollbar", "chart"]).setAll({
			...
			paddingTop: 0,
			paddingRight: 0,
			colors: ColorSet.new(this._root, { saturation: 0 })
		});
		{
			const rule = r("Graphics", ["scrollbar", "overlay"]);
			rule.setAll({ fillOpacity: .5 });
		...
		r("RoundedRectangle", [
			...
			"scrollbar",
			"thumb"
		]).states.create("hover", { fillOpacity: .4 });
		r("RoundedRectangle", [
			"xy",
			"scrollbar",
			"chart",
		...
		r("AxisLabel", ["x", "inside"]).setAll({ centerY: p100 });
		r("AxisLabel", [
			"x",
			"inside",
			"opposite"
		]).setAll({ centerY: 0 });
		r("AxisLabel", ["x", "opposite"]).setAll({ centerY: p100 });
		r("AxisLabel", ["y"]).setAll({ centerX: p100 });
		...
		r("AxisLabel", ["minor"]).setAll({ fontSize: "0.6em" });
		r("AxisLabel", [
			"xy",
			"scrollbar",
			"y"
		...
		*/
		...
		});
		{
			...
			rule.setAll({ fillOpacity: 0 });
			setColor(rule, "fill", ic, "alternativeBackground");
			rule.states.create("hover", { fillOpacity: .1 });
		}
		r("Rectangle", [
			"axis",
			"thumb",
			"x",
			"zoomgrip"
		]).setAll({ cursorOverStyle: "ew-resize" });
		r("Rectangle", [
			"axis",
			"thumb",
			"y",
			"zoomgrip"
		]).setAll({ cursorOverStyle: "ns-resize" });
		{
			const rule = r("Grid");
			rule.setAll({
				location: 0,
		...
		r("Grid", ["base"]).setAll({ strokeOpacity: .3 });
		{
		...
		r("Grid", ["series", "range"]).setAll({ visible: false });
		r("AxisTick", ["series", "range"]).setAll({ visible: false });
		r("AxisLabel", ["series", "range"]).setAll({ visible: false });
		{
		...
		r("CategoryAxis").setAll({
			...
			fillRule: (dataItem, index) => {
				...
				if (axisFill) if (!isNumber(index) || index % 2 == 0) axisFill.setPrivate("visible", true);
				else axisFill.setPrivate("visible", false);
			}
		});
		const gridIntervals = [
			{
		...
		r("DateAxis").setAll({
			...
			fillRule: (dataItem) => {
				...
				if (axisFill) {
					...
					min = round$1(new Date(min), gridInterval.timeUnit, gridInterval.count, this._root.locale.firstDayOfWeek, this._root.utc, void 0, this._root.timezone).getTime();
					if (value != null && endValue != null) {
						const val = Math.round(Math.round((value - min) / intervalDuration)) / 2;
						if (val == Math.round(val)) axisFill.setPrivate("visible", true);
						else axisFill.setPrivate("visible", false);
					}
				}
			}
		});
		r("GaplessDateAxis").setAll({ fillRule: (dataItem) => {
			const axisFill = dataItem.get("axisFill");
			if (axisFill) {
		...
		r("ValueAxis").setAll({
			...
			fillRule: (dataItem) => {
				...
				if (axisFill) {
					...
					if (isNumber(value) && isNumber(step)) if (round(value / step / 2, 5) == Math.round(value / step / 2)) axisFill.setPrivate("visible", false);
					else axisFill.setPrivate("visible", true);
				}
			}
		});
		...
		*/
		...
		r("BaseColumnSeries").setAll({ adjustBulletPosition: true });
		r("ColumnSeries").setAll({ clustered: true });
		...
		setColor(r("Graphics", [
			...
			"marker",
			"stroke"
		]).states.create("disabled", {}), "stroke", ic, "disabled");
		r("Graphics", [
			"line",
			"series",
			"legend",
		...
		r("SmoothedXYLineSeries").setAll({ tension: .5 });
		r("SmoothedXLineSeries").setAll({ tension: .5 });
		r("SmoothedYLineSeries").setAll({ tension: .5 });
		...
		r("Rectangle", [
			...
			"autocolor",
			"pro"
		]).states.create("riseFromOpen", { fillOpacity: 0 });
		r("Rectangle", [
			"column",
			"autocolor",
			"pro"
		]).states.create("dropFromOpen", { fillOpacity: 1 });
		{
			const rule = r("Rectangle", [
				"column",
				"autocolor",
		...
		r("RoundedRectangle", ["rangegrip"]).setAll({
			strokeOpacity: 0,
			fillOpacity: 0,
			strokeWidth: 1,
			width: 12,
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/XYChart.js
/**
* Creates an XY chart.
*
...
var XYChart = class extends SerialChart {
		...
		*/
		Object.defineProperty(this, "zoomOutButton", {
			...
			value: this.topPlotContainer.children.push(Button.new(this._root, {
				themeTags: ["zoom"],
				icon: Graphics.new(this._root, { themeTags: ["button", "icon"] })
			}))
		});
	...
	_afterNew() {
		...
		plotContainer.set("background", Rectangle.new(root, { themeTags: [
			"plotbackground",
			"xy",
			"background"
		] }));
	...
	_removeSeries(series) {
		series._unstack();
		if (series._posXDp) series._posXDp.dispose();
		if (series._posYDp) series._posYDp.dispose();
	...
	*/
	handleWheel(event) {
		...
		let prevent = false;
		if (isLocalEvent(wheelEvent, this)) prevent = true;
		else return;
		const plotPoint = plotContainer.toLocal(event.point);
		const wheelStep = this.get("wheelStep", .2);
		const shiftY = wheelEvent.deltaY / 100;
		const shiftX = wheelEvent.deltaX / 100;
		const wheelZoomPositionX = this.get("wheelZoomPositionX");
		const wheelZoomPositionY = this.get("wheelZoomPositionY");
		if ((wheelX === "zoomX" || wheelX === "zoomXY") && shiftX != 0) this.xAxes.each((axis) => {
			if (axis.get("zoomX")) {
				let start = axis.get("start");
				let end = axis.get("end");
				let position = axis.fixPosition(plotPoint.x / plotContainer.width());
				if (wheelZoomPositionX != null) position = wheelZoomPositionX;
				...
				if (newStart == start && newEnd == end) prevent = false;
				if (1 / (newEnd - newStart) < axis.getPrivate("maxZoomFactor", Infinity) / axis.get("minZoomCount", 1)) this._handleWheelAnimation(axis.zoom(newStart, newEnd));
				else prevent = false;
			}
		});
		if ((wheelY === "zoomX" || wheelY === "zoomXY") && shiftY != 0) this.xAxes.each((axis) => {
			if (axis.get("zoomX")) {
				let start = axis.get("start");
				let end = axis.get("end");
				let position = axis.fixPosition(plotPoint.x / plotContainer.width());
		...
		if ((wheelX === "zoomY" || wheelX === "zoomXY") && shiftX != 0) this.yAxes.each((axis) => {
			if (axis.get("zoomY")) {
				let start = axis.get("start");
				let end = axis.get("end");
				let position = axis.fixPosition(plotPoint.y / plotContainer.height());
				if (wheelZoomPositionY != null) position = wheelZoomPositionY;
				let maxDeviation = axis.get("maxDeviation", 0);
				let newStart = Math.min(1 + maxDeviation, Math.max(-maxDeviation, start - wheelStep * (end - start) * shiftX * position));
				let newEnd = Math.max(-maxDeviation, Math.min(1 + maxDeviation, end + wheelStep * (end - start) * shiftX * (1 - position)));
				if (newStart == start && newEnd == end) prevent = false;
		...
		if ((wheelY === "zoomY" || wheelY === "zoomXY") && shiftY != 0) this.yAxes.each((axis) => {
			if (axis.get("zoomY")) {
				let start = axis.get("start");
				let end = axis.get("end");
				let position = axis.fixPosition(plotPoint.y / plotContainer.height());
		...
		if ((wheelX === "panX" || wheelX === "panXY") && shiftX != 0) this.xAxes.each((axis) => {
			if (axis.get("panX")) {
				let start = axis.get("start");
				let end = axis.get("end");
		...
		if ((wheelY === "panX" || wheelY === "panXY") && shiftY != 0) this.xAxes.each((axis) => {
			if (axis.get("panX")) {
				let start = axis.get("start");
				let end = axis.get("end");
		...
		if ((wheelX === "panY" || wheelX === "panXY") && shiftX != 0) this.yAxes.each((axis) => {
			if (axis.get("panY")) {
				let start = axis.get("start");
				let end = axis.get("end");
				let delta = this._getWheelSign(axis) * wheelStep * (end - start) * shiftX;
		...
		if ((wheelY === "panY" || wheelY === "panXY") && shiftY != 0) this.yAxes.each((axis) => {
			if (axis.get("panY")) {
				let start = axis.get("start");
				let end = axis.get("end");
				let delta = this._getWheelSign(axis) * wheelStep * (end - start) * shiftY;
		...
		if (prevent) wheelEvent.preventDefault();
	}
	_handleSetWheel() {
		const wheelX = this.get("wheelX");
		const wheelY = this.get("wheelY");
		...
		if (wheelX !== "none" || wheelY !== "none") {
			this._wheelDp = plotContainer.events.on("wheel", (event) => {
				const wheelEvent = event.originalEvent;
				if (wheelX !== "none" && Math.abs(wheelEvent.deltaX) != 0 || wheelY !== "none" && Math.abs(wheelEvent.deltaY) != 0) this.handleWheel(event);
			});
	...
	_handlePlotDown(event) {
		...
		if (this.get("panX") || this.get("panY")) {
			if (local.x >= 0 && local.y >= 0 && local.x <= plotContainer.width() && local.y <= this.height()) {
				...
				if (panX) this.xAxes.each((axis) => {
					axis._panStart = axis.get("start");
					axis._panEnd = axis.get("end");
				});
				if (panY) this.yAxes.each((axis) => {
					axis._panStart = axis.get("start");
					axis._panEnd = axis.get("end");
				});
	...
	_handleWheelAnimation(animation) {
		if (animation) animation.events.on("stopped", () => {
			...
			if (panX) {
				...
				this.xAxes.each((axis) => {
					if (axis.get("panX")) {
						...
						let deltaX = (panEnd - panStart) * (downPoint.x - local.x) / plotContainer.width();
			...
			if (panY) {
				...
				this.yAxes.each((axis) => {
					if (axis.get("panY")) {
						...
						let panStart = axis._panStart;
						let panEnd = axis._panEnd;
						let deltaY = (panEnd - panStart) * (downPoint.y - local.y) / plotContainer.height();
			...
			if (downPoint0 && downPoint1 && movePoint0 && movePoint1) {
				...
				if (this.get("pinchZoomX")) {
					...
					if (downStartX != null && downEndX != null) {
						...
						let d = Math.max(.001, downPos1 - downPos0) / Math.max(.001, movePos1 - movePos0);
		...
		if (cursor) {
			...
			if (snapToSeries && cursorPoint) {
				...
				each$1(snapToSeries, (series) => {
					if (!series.isHidden() && !series.isHiding()) if (snapToSeriesBy != "x!" && snapToSeriesBy != "y!") {
						const startIndex = series.startIndex();
						const endIndex = series.endIndex();
						for (let i = startIndex; i < endIndex; i++) {
							const dataItem = series.dataItems[i];
							if (dataItem && !dataItem.isHidden()) dataItems.push(dataItem);
						}
					} else {
						const tooltipDataItem = series.get("tooltipDataItem");
						if (tooltipDataItem) dataItems.push(tooltipDataItem);
					}
				});
				...
				each$1(dataItems, (dataItem) => {
					...
					if (point) {
						let distance = 0;
						if (snapToSeriesBy == "x" || snapToSeriesBy == "x!") distance = Math.abs(cursorPoint.x - point.x);
						else if (snapToSeriesBy == "y" || snapToSeriesBy == "y!") distance = Math.abs(cursorPoint.y - point.y);
						else distance = Math.hypot(cursorPoint.x - point.x, cursorPoint.y - point.y);
			...
			if (scrollbarX !== previous) {
				...
				if (scrollbarX) {
					...
					this._pushPropertyDisposer("scrollbarX", scrollbarX.events.on("released", () => {
						this.xAxes.each((axis) => {
							if (axis.get("zoomable")) this._handleAxisSelection(axis);
						});
					}));
	...
	_processSeries(series) {
		...
		if (!series.get("baseAxis")) if (yAxis.isType("CategoryAxis") || yAxis.isType("DateAxis")) series.set("baseAxis", yAxis);
		else series.set("baseAxis", xAxis);
	...
	_handleCursorSelectEnd() {
		...
		const positionX = Math.min(1, Math.max(0, cursor.getPrivate("positionX", .5)));
		const positionY = Math.min(1, Math.max(0, cursor.getPrivate("positionY", .5)));
		this.xAxes.each((axis) => {
	...
	_handleScrollbar(axes, start, end, priority) {
		axes.each((axis) => {
			...
			if (zoomAnimation) zoomAnimation.events.on("stopped", () => {
	...
	_processAxis(axes, container) {
		return axes.events.onAll((change) => {
			if (change.type === "clear") each$1(change.oldValues, (axis) => {
				...
				change.newValue.processChart(this);
			} else if (change.type === "removeIndex") this._removeAxis(change.oldValue);
		...
		if (zoomOutButton && zoomOutButton.parent) {
			...
			this.xAxes.each((axis) => {
				if (axis.get("zoomOut", true)) {
					if (round(axis.get("start", 0), 5) != 0 || round(axis.get("end", 1), 5) != 1) visible = true;
				}
			});
			this.yAxes.each((axis) => {
				if (axis.get("zoomOut", true)) {
	...
	*/
	inPlot(point) {
		...
		if (point.x >= -.5 && point.y >= -.5 && point.x <= plotContainer.width() + .5 && point.y <= plotContainer.height() + .5) return true;
		if (otherCharts) for (let i = otherCharts.length - 1; i >= 0; i--) {
	...
	*/
	arrangeTooltips() {
		...
		if (bounds) {
			if (bounds.bottom > hh) hh = bounds.bottom;
		}
		...
		let closest;
		let closestPoint;
		if (isNumber(maxTooltipDistance)) this.series.each((series) => {
			if (!series.isHidden()) {
				const tooltip = series.get("tooltip");
				if (tooltip) {
					...
					if (point) {
						...
						if (maxTooltipDistanceBy == "x") distance = Math.abs(movePoint.x - point.x);
						else if (maxTooltipDistanceBy == "y") distance = Math.abs(movePoint.y - point.y);
						if (distance < minDistance) {
							minDistance = distance;
							closest = series;
							closestPoint = point;
					...
					if (maxTooltipDistance >= 0) {
						...
						if (point && closestPoint) {
							if (series != closest) {
								...
								if (maxTooltipDistanceBy == "x") distance = Math.abs(closestPoint.x - point.x);
								else if (maxTooltipDistanceBy == "y") distance = Math.abs(closestPoint.y - point.y);
								if (distance > maxTooltipDistance) hidden = true;
							}
						}
					} else if (maxTooltipDistance == -1) {
						if (series != closest) hidden = true;
					}
					if (!this.inPlot(this._tooltipToLocal(point)) || !tooltip.dataItem) hidden = true;
					else if (!hidden) sum += point.y;
					if (hidden || series.isHidden() || series.isHiding()) tooltip.hide(0);
					else {
						tooltip.show();
		...
		if (this.get("arrangeTooltips")) {
			...
			if (sum / count > h / 2 + plotT.y) {
				...
				each$1(tooltips, (tooltip) => {
					...
					if (tooltip.parent == tooltipContainer) tooltipContainer.children.moveValue(tooltip, 0);
				});
				if (prevY < 0) {
					tooltips.reverse();
			...
			if (totalTooltipH == 0 && tooltipCount > 0) this._disposers.push(this.root.events.once("frameended", () => {
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/Grid.js
/**
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/XYCursor.js
/**
...
var XYCursor = class extends Container {
	constructor() {
		...
		*/
		Object.defineProperty(this, "lineX", {
			...
			configurable: true,
			writable: true,
			value: this.children.push(Grid.new(this._root, { themeTags: ["x"] }))
		});
		/**
		* A [[Grid]] elment that used for horizontal line of the cursor crosshair.
		*
		...
		*/
		Object.defineProperty(this, "lineY", {
			...
			configurable: true,
			writable: true,
			value: this.children.push(Grid.new(this._root, { themeTags: ["y"] }))
		});
		/**
	...
	_afterNew() {
		...
		if (supports("keyboardevents")) this._disposers.push(addEventListener(document, "keydown", (ev) => {
			this._handleLineMove(getEventKey(ev), ev.ctrlKey);
		}));
	}
	_setUpTouch() {
		const chart = this.chart;
		if (chart) chart.plotContainer._display.cancelTouch = this.get("behavior") != "none" ? true : false;
	}
	_handleXLine() {
		let x = this.lineX.x();
		let visible = true;
		if (x < 0 || x > this.width()) visible = false;
		this.lineX.setPrivate("visible", visible);
	}
	_handleYLine() {
		let y = this.lineY.y();
		let visible = true;
		if (y < 0 || y > this.height()) visible = false;
	...
	_handleLineBlur() {
		if (this.lineX.isFocus() || this.lineY.isFocus()) this.setAll({
			positionX: void 0,
			positionY: void 0,
	...
	_handleSyncWith() {
		...
		if (chart) {
			...
			const otherCharts = [];
			if (syncWith) each$1(syncWith, (cursor) => {
				const chart = cursor.chart;
				if (chart) otherCharts.push(chart);
			});
	...
	_updateChildren() {
		...
		if (this.isDirty("positionX") || this.isDirty("positionY")) {
			...
			if (positionX == null && positionY == null) this.hide(0);
			else {
	...
	updateCursor() {
		if (this.get("alwaysShow")) this._movePoint = this.toGlobal(this._getPoint(this.get("positionX", 0), this.get("positionY", 0)));
		this.handleMove();
	}
	_setChart(chart) {
		this.chart = chart;
		...
		if (supports("touchevents")) {
			this._disposers.push(plotContainer.events.on("click", (event) => {
				if (isTouchEvent(event.originalEvent)) this._handleMove(event);
			}));
			this._setUpTouch();
		}
		this._disposers.push(plotContainer.events.on("pointerdown", (event) => {
		...
		this._disposers.push(plotContainer.events.on("globalpointerup", (event) => {
			...
			if (!event.native && !this.isHidden()) this._handleMove(event);
		}));
		this._disposers.push(plotContainer.events.on("globalpointermove", (event) => {
			if (!this.get("syncWith")) {
				if (keys(plotContainer._downPoints).length == 0 && !event.native && this.isHidden()) return;
			}
		...
		if (parent) parent.children.moveValue(this.selection);
	}
	_inPlot(point) {
		const chart = this.chart;
		if (chart) return chart.inPlot(point);
		return false;
	}
	...
	_handleCursorUp(event) {
		if (this._downPoint) {
			...
			if (behavior != "none") {
				if (behavior.charAt(0) === "z") this.selection.hide();
				const rootPoint = event.point;
				let local = this._display.toLocal(rootPoint);
				const downPoint = this._downPoint;
				...
				if (local && downPoint) {
					...
					if (behavior === "zoomX" || behavior === "zoomXY" || behavior === "selectX" || behavior === "selectXY") {
						if (Math.abs(local.x - downPoint.x) > moveThreshold) dispatch = true;
					}
					if (behavior === "zoomY" || behavior === "zoomXY" || behavior === "selectY" || behavior === "selectXY") {
						if (Math.abs(local.y - downPoint.y) > moveThreshold) dispatch = true;
					}
					if (dispatch) {
	...
	_handleMove(event) {
		if (this.getPrivate("visible")) {
			...
			if (chart && keys(chart.plotContainer._downPoints).length > 1) {
				...
				return;
			} else this.set("forceHidden", false);
			const rootPoint = event.point;
			const lastPoint = this._lastPoint;
			if (Math.round(lastPoint.x) === Math.round(rootPoint.x) && Math.round(lastPoint.y) === Math.round(rootPoint.y)) return;
	...
	*/
	handleMove(point, skipEvent, originalEvent) {
		if (!point) point = this._movePoint;
		...
		if (chart && (this._inPlot(local) || this._downPoint)) {
			...
			if (this.isHidden()) {
				this.show();
				if (this.get("behavior", "").charAt(0) == "z") this.selection.set("draw", () => {});
			}
			let x = local.x;
			let y = local.y;
			...
			if (this._downPoint) snapToSeries = void 0;
			let userPositionX = this.get("positionX");
			let positionX = xyPos.x;
			if (isNumber(userPositionX)) positionX = userPositionX;
			let userPositionY = this.get("positionY");
			let positionY = xyPos.y;
			if (isNumber(userPositionY)) positionY = userPositionY;
			...
			chart.xAxes.each((axis) => {
				...
				if (alwaysShow) axis.handleCursorShow();
			});
		...
		if (this._downPoint && this.get("behavior") != "none") this._updateSelection(local);
	}
	...
	_updateLines(x, y) {
		if (!this._tooltipX) this.lineX.set("x", x);
		if (!this._tooltipY) this.lineY.set("y", y);
		this._drawLines();
	}
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/series/XYSeries.js
/**
* @ignore
*/
...
var XYSeries = class extends Series {
	constructor() {
		...
		Object.defineProperty(this, "_xRenderer", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0
		});
		Object.defineProperty(this, "_yRenderer", {
			enumerable: true,
			configurable: true,
			writable: true,
			value: void 0
	...
	_afterNew() {
		...
		const xAxis = this.get("xAxis");
		if (xAxis) this._xRenderer = xAxis.get("renderer");
		const yAxis = this.get("yAxis");
		if (yAxis) this._yRenderer = yAxis.get("renderer");
		super._afterNew();
		this.set("maskContent", true);
		this._disposers.push(this.axisRanges.events.onAll((change) => {
			if (change.type === "clear") each$1(change.oldValues, (axisRange) => {
				this._removeAxisRange(axisRange);
			});
			else if (change.type === "push") this._processAxisRange(change.newValue);
			else if (change.type === "setIndex") this._processAxisRange(change.newValue);
			else if (change.type === "insertIndex") this._processAxisRange(change.newValue);
			else if (change.type === "removeIndex") this._removeAxisRange(change.oldValue);
			else if (change.type === "moveIndex") this._processAxisRange(change.value);
	...
	_updateFields() {
		...
		if (this.valueXFields) each$1(this.valueXFields, (key) => {
			if (this.get(key + "Field")) {
				this._valueXFields.push(key);
				let field = this.get(key + "Show");
				this.__valueXShowFields.push(field);
				if (field.indexOf("Working") != -1) this._valueXShowFields.push(field.split("Working")[0]);
				else this._valueXShowFields.push(field);
			}
		});
		if (this.valueYFields) each$1(this.valueYFields, (key) => {
			if (this.get(key + "Field")) {
				this._valueYFields.push(key);
				let field = this.get(key + "Show");
				this.__valueYShowFields.push(field);
				if (field.indexOf("Working") != -1) this._valueYShowFields.push(field.split("Working")[0]);
				else this._valueYShowFields.push(field);
			}
		});
	}
	_dispose() {
	...
	_shouldMakeBullet(dataItem) {
		...
		if (!xAxis.inited || !yAxis.inited) return false;
		const minBulletDistance = this.get("minBulletDistance", 0);
		if (minBulletDistance > 0) {
			let startIndex = this.startIndex();
			let count = this.endIndex() - startIndex;
			if (xAxis == baseAxis) {
				if (this._xRenderer.axisLength() / count < minBulletDistance / 5) return false;
			} else if (yAxis == baseAxis) {
				if (this._yRenderer.axisLength() / count < minBulletDistance / 5) return false;
			}
		}
		if (dataItem.get(this._xField) != null && dataItem.get(this._yField) != null) return true;
		return false;
	}
	_makeFieldNames() {
		const xAxis = this.get("xAxis");
	...
	_fixVC() {
		...
		if (hiddenState) {
			...
			if (xAxis === baseAxis) hiddenState.set("vcy", value);
			else if (yAxis === baseAxis) hiddenState.set("vcx", value);
			else {
	...
	_prepareChildren() {
		...
		if (this.isDirty("xAxis") || this.isDirty("yAxis")) this._valuesDirty = true;
		...
		switch (tooltipPositionX) {
			...
			case "high":
				...
				break;
			default: tooltipFieldX = this._xField;
		}
		...
		switch (tooltipPositionY) {
			...
			case "high":
				...
				break;
			default: tooltipFieldY = this._yField;
		}
		this._tooltipFieldY = tooltipFieldY;
		if (this.isDirty("baseAxis")) this._fixVC();
		this._fixPosition();
		const stacked = this.get("stacked");
		if (this.isDirty("stacked")) if (stacked) if (this._valuesDirty && !this._dataProcessed) {} else this._stack();
		else this._unstack();
		if (this._valuesDirty && !this._dataProcessed) {
			...
			each$1(this.dataItems, (dataItem) => {
				each$1(this._valueXShowFields, (key) => {
					...
					if (value != null) {
						if (stacked) value += this.getStackedXValue(dataItem, key);
				...
				each$1(this._valueYShowFields, (key) => {
					let value = dataItem.get(key);
					if (value != null) {
						if (stacked) value += this.getStackedYValue(dataItem, key);
		...
		if (this._valuesDirty || this.isPrivateDirty("startIndex") || this.isPrivateDirty("adjustedStartIndex") || this.isPrivateDirty("endIndex") || this.isDirty("vcx") || this.isDirty("vcy") || this._stackDirty || this._sizeDirty) {
			...
			if (minBulletDistance > 0 && baseAxis) if (baseAxis.get("renderer").axisLength() / (endIndex - startIndex) > minBulletDistance) this._showBullets = true;
			else this._showBullets = false;
			if ((this._psi != startIndex || this._pei != endIndex || this.isDirty("vcx") || this.isDirty("vcy") || this.isPrivateDirty("adjustedStartIndex") || this._stackDirty || this._valuesDirty) && !this._selectionProcessed) {
				...
				if (baseAxis === xAxis || !baseAxis) {
					...
					if (!outOfSelection) for (let i = startIndex; i < endIndex; i++) this.processYSelectionDataItem(this.dataItems[i], vcy, stacked);
					else yAxis.markDirtySelectionExtremes();
				}
				if (baseAxis === yAxis || !baseAxis) {
					xAxis._calculateTotals();
					this.setPrivateRaw("selectionMinX", void 0);
					this.setPrivateRaw("selectionMaxX", void 0);
					if (!outOfSelection) for (let i = startIndex; i < endIndex; i++) this.processXSelectionDataItem(this.dataItems[i], vcx, stacked);
					else yAxis.markDirtySelectionExtremes();
				}
				if (baseAxis === xAxis || !baseAxis) {
	...
	_handleRemoved() {
		const xAxis = this.get("xAxis");
		if (xAxis) xAxis._handleSeriesRemoved();
		const yAxis = this.get("yAxis");
		if (yAxis) yAxis._handleSeriesRemoved();
	}
	_stackDataItems() {
		const baseAxis = this.get("baseAxis");
		const xAxis = this.get("xAxis");
				...
				if (stackToItem) {
					...
					if (stackToNegative) if (isNumber(value)) {
						if (isNumber(stackValue)) {
							if (s == len - 1) dataItem.setRaw(stackToItemKey, void 0);
					...
					else if (isNumber(value) && isNumber(stackValue)) {
						dataItem.setRaw(stackToItemKey, stackToItem);
						this._reallyStackedTo[stackToSeries.uid] = stackToSeries;
						stackToSeries._stackedSeries[this.uid] = this;
						break;
	...
	processXSelectionDataItem(dataItem, vcx, stacked) {
		each$1(this.__valueXShowFields, (key) => {
			let value = dataItem.get(key);
			if (value != null) {
				if (stacked) value += this.getStackedXValueWorking(dataItem, key);
	...
	processYSelectionDataItem(dataItem, vcy, stacked) {
		each$1(this.__valueYShowFields, (key) => {
			let value = dataItem.get(key);
			if (value != null) {
				if (stacked) value += this.getStackedYValueWorking(dataItem, key);
	...
	*/
	...
	_positionBullet(bullet) {
		...
		if (sprite) {
			...
			let locationX = bullet.get("locationX", dataItem.get("locationX", .5));
			let locationY = bullet.get("locationY", dataItem.get("locationY", .5));
			...
			if (this._shouldShowBullet(positionX, positionY)) {
				...
				if (field != void 0) {
					let realField;
					if (baseAxis == xAxis) {
						if (field == "value") realField = this._yField;
						else if (field == "open") realField = this._yOpenField;
						else if (field == "high") realField = this._yHighField;
						else if (field == "low") realField = this._yLowField;
						if (realField) {
						...
						if (field == "value") realField = this._xField;
						else if (field == "open") realField = this._xOpenField;
						else if (field == "high") realField = this._xHighField;
						else if (field == "low") realField = this._xLowField;
						if (realField) {
				...
				if (stacked) {
					...
					if (baseAxis == xAxis) {
						...
						if (previousBullet) {
							...
							if (stacked == "down") y = previousBounds.bottom - bounds.top;
							else if (stacked == "auto") {
								if (chart) if (yo < chart.plotContainer.height() / 2) y = previousBounds.bottom - bounds.top;
						...
						if (previousBullet) {
							...
							if (stacked == "down") x = previousBounds.left - bounds.right;
							else if (stacked == "auto") {
								if (chart) if (xo < chart.plotContainer.width() / 2) x = previousBounds.left - bounds.right;
								else x -= bounds.left;
							} else x -= bounds.left;
						}
						this._bullets[positionX + "_" + positionY] = sprite;
	...
	*/
	resetGrouping() {
		each(this._dataSets, (_key, dataSet) => {
			if (dataSet != this._mainDataItems) each$1(dataSet, (dataItem) => {
				dataItem.dispose();
			});
		});
		this._dataSets = {};
	...
	_handleDataSetChange() {
		each$1(this._dataItems, (dataItem) => {
			...
			if (bullets) each$1(bullets, (bullet) => {
				if (bullet) {
					let sprite = bullet.get("sprite");
					if (sprite) sprite.setPrivate("visible", false);
				}
	...
	*/
	show(duration) {
		const _super = Object.create(null, { show: { get: () => super.show } });
	...
	*/
	hide(duration) {
		const _super = Object.create(null, { hide: { get: () => super.hide } });
		return __awaiter(this, void 0, void 0, function* () {
			this._fixVC();
			let promises = [];
	...
	*/
	hideDataItem(dataItem, duration) {
		...
		return __awaiter(this, void 0, void 0, function* () {
			...
			if (!hiddenState) hiddenState = this.states.create("hidden", {});
			...
			const baseAxis = this.get("baseAxis");
			const stacked = this.get("stacked");
			if (baseAxis === xAxis || !baseAxis) each$1(this._valueYFields, (key) => {
				let min = yAxis.getPrivate("min");
				let baseValue = yAxis.baseValue();
				if (isNumber(min) && min > baseValue) baseValue = min;
				if (stacked) baseValue = 0;
				if (dataItem.get(key) != null) promises.push(dataItem.animate({
					key: key + "Working",
					to: baseValue,
					duration,
					easing
	...
	_markStakedDirtyStack() {
		...
		if (stackedSeries) each(stackedSeries, (_key, value) => {
	...
	*/
	showDataItemTooltip(dataItem) {
		...
		if (tooltip) if (!this.isHidden() && this.get("visible")) {
			...
			if (dataItem) {
				...
				each$1(this._valueFields, (field) => {
					if (dataItem.get(field) == null) show = false;
				});
				if (show) {
					const chart = this.chart;
	...
	*/
	_adjustStartIndex(index) {
		...
		if (this.get("baseAxis") == xAxis && xAxis.isType("DateAxis")) {
			...
			const dl = baseDuration * this.get("locationX", .5);
			let value = -Infinity;
			while (value < minSelection) {
				const dataItem = this.dataItems[index];
				if (dataItem) {
					const open = dataItem.open;
					if (open) value = open["valueX"];
					else value = dataItem.get("valueX", 0);
					value += dl;
					if (value < minSelection) index++;
					else break;
				} else break;
			}
		}
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/series/BaseColumnSeries.js
/**
* Base class for all "column-based" series
*/
var BaseColumnSeries = class BaseColumnSeries extends XYSeries {
	constructor() {
		super(...arguments);
	...
	_makeFieldNames() {
		...
		if (xAxis.isType(categoryAxis)) {
			if (!this.get("openCategoryXField")) this._xOpenField = this._xField;
		}
		if (xAxis.isType(valueAxis)) {
			if (!this.get("openValueXField")) this._xOpenField = this._xField;
		}
		if (yAxis.isType(categoryAxis)) {
			if (!this.get("openCategoryYField")) this._yOpenField = this._yField;
		}
		if (yAxis.isType(valueAxis)) {
			if (!this.get("openValueYField")) this._yOpenField = this._yField;
		}
	}
	_prepareChildren() {
		super._prepareChildren();
		...
		if (xAxis.inited && yAxis.inited) for (let i = startIndex; i <= endIndex; i++) {
	...
	_updateChildren() {
		...
		if (this.isDirty("fill")) {
			if (columnsTemplate.get("fill") == null) columnsTemplate.set("fill", this.get("fill"));
		}
		if (this.isDirty("fillPattern")) {
			if (columnsTemplate.get("fillPattern") == null) columnsTemplate.set("fillPattern", this.get("fillPattern"));
		}
		if (this.isDirty("stroke")) {
			if (columnsTemplate.get("stroke") == null) columnsTemplate.set("stroke", this.get("stroke"));
		}
		let index = 0;
		let clusterCount = 0;
		let i = 0;
		if (baseAxis) each$1(baseAxis.series, (series) => {
			if (series instanceof BaseColumnSeries) {
				const stacked = series.get("stacked");
				if (stacked && i == 0) clusterCount++;
				if (!stacked && series.get("clustered")) clusterCount++;
			}
			if (series === this) index = clusterCount - 1;
			i++;
		});
		...
		if (xAxis.inited && yAxis.inited) {
			if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty) {
				...
				for (let i = 0; i < startIndex; i++) this._toggleColumn(this.dataItems[i], false);
				let previous = this.dataItems[startIndex];
				for (let i = startIndex; i <= endIndex; i++) {
					let dataItem = this.dataItems[i];
					if (dataItem.get("valueX") != null && dataItem.get("valueY") != null) {
						previous = dataItem;
						if (i > 0 && startIndex > 0) for (let j = i - 1; j >= 0; j--) {
				...
				let axisCase = 0;
				if (yAxis.isType("CategoryAxis") && xAxis.isType("CategoryAxis")) axisCase = 2;
				else if (xAxis === baseAxis) axisCase = 0;
				else if (yAxis === baseAxis) axisCase = 1;
				for (let i = startIndex; i <= endIndex; i++) {
					let dataItem = this.dataItems[i];
					this._updateGraphics(dataItem, previous, axisCase);
					if (dataItem.get("valueX") != null && dataItem.get("valueY") != null) previous = dataItem;
				}
				this._afterColumnsDraw();
				for (let i = endIndex + 1; i < len; i++) this._toggleColumn(this.dataItems[i], false);
				this._columnsUpdated = true;
			}
		} else this._skipped = true;
		if (!this.getPrivate("doNotUpdateLegend")) this.updateLegendMarker(this.get("tooltipDataItem"));
		super._updateChildren();
	}
	_afterChanged() {
		super._afterChanged();
	...
	_createGraphics(dataItem) {
		...
		if (!graphics) {
			...
			if (graphicsArray) each$1(graphicsArray, (graphics) => {
				graphics.dispose();
			});
			graphicsArray = [];
			...
			this.axisRanges.each((axisRange) => {
				...
				if (graphicsArray) graphicsArray.push(rangeGraphics);
	...
	_updateGraphics(dataItem, previousDataItem, axisCase) {
		...
		if (valueX != null && valueY != null) {
			...
			const locationX = this.get("locationX", dataItem.get("locationX", .5));
			const locationY = this.get("locationY", dataItem.get("locationY", .5));
			...
			let fitH = false;
			if (axisCase == 0) {
				let startLocation = this._aLocationX0 + openLocationX - .5;
				let endLocation = this._aLocationX1 + locationX - .5;
				...
				if (this._yOpenField !== this._yField) b = yAxis.getDataItemPositionY(dataItem, yOpenField, openLocationY, vcy);
				else if (stacked) {
					let stackToItemY = dataItem.get("stackToItemY");
					if (stackToItemY) b = yAxis.getDataItemPositionY(stackToItemY, yField, openLocationY, stackToItemY.component.get("vcy"));
				...
				let startLocation = this._aLocationY0 + openLocationY - .5;
				let endLocation = this._aLocationY1 + locationY - .5;
				...
				if (this._xOpenField !== this._xField) l = xAxis.getDataItemPositionX(dataItem, xOpenField, openLocationX, vcx, exactLocationX);
				else if (stacked) {
					let stackToItemX = dataItem.get("stackToItemX");
					if (stackToItemX) l = xAxis.getDataItemPositionX(stackToItemX, xField, openLocationX, stackToItemX.component.get("vcx"), exactLocationX);
			...
			if (l < xStart && r < xStart || l > xEnd && r > xEnd || t < yStart && b <= yStart || t >= yEnd && b > yEnd || isNaN(l) || isNaN(t)) this._toggleColumn(dataItem, false);
			else this._toggleColumn(dataItem, true);
			let rangeGraphics = dataItem.get("rangeGraphics");
			if (rangeGraphics) each$1(rangeGraphics, (graphics) => {
				this._updateSeriesGraphics(dataItem, graphics, l, r, t, b, fitW, fitH);
			});
		} else this._toggleColumn(dataItem, false);
	}
	...
	*/
	...
	_getTooltipTarget(dataItem) {
		if (this.get("seriesTooltipTarget") == "bullet") return super._getTooltipTarget(dataItem);
		let column = dataItem.get("graphics");
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/Axis.js
/**
...
var Axis = class extends Component {
	...
	_afterNew() {
		...
		this._disposers.push(this.axisRanges.events.onAll((change) => {
			if (change.type === "clear") each$1(change.oldValues, (dataItem) => {
				dataItem.dispose();
			});
			else if (change.type === "push") this._processAxisRange(change.newValue, ["range"]);
			else if (change.type === "setIndex") this._processAxisRange(change.newValue, ["range"]);
			else if (change.type === "insertIndex") this._processAxisRange(change.newValue, ["range"]);
			else if (change.type === "removeIndex") this.disposeDataItem(change.oldValue);
			else if (change.type === "moveIndex") this._processAxisRange(change.value, ["range"]);
			else throw new Error("Unknown IStreamEvent type");
		}));
	...
	_createGhostLabel() {
		const ghostLabel = this.get("renderer").makeLabel(new DataItem(this, void 0, {}), []);
	...
	zoom(start, end, duration, priority) {
		if (this.get("zoomable", true)) {
			...
			if (this.get("start") !== start || this.get("end") != end) {
				...
				if (start > end) [start, end] = [end, start];
				let maxDeviation = this.get("maxDeviation", .5) * Math.min(1, end - start);
				...
				if (end === 1 && start !== 0) if (start < this.get("start", 0)) priority = "start";
				else priority = "end";
				if (start === 0 && end !== 1) if (end > this.get("end", 1)) priority = "end";
				else priority = "start";
				let minZoomCount = this.get("minZoomCount", 0);
				const dataItems = this.dataItems;
				if (dataItems && dataItems.length < minZoomCount) minZoomCount = dataItems.length;
				...
				if (duration > 0) {
					...
					if (this.get("start") != start) sAnimation = this.animate({
						key: "start",
						to: start,
						duration,
						easing
					});
					if (this.get("end") != end) eAnimation = this.animate({
						key: "end",
						to: end,
						duration,
						easing
					...
					if (sAnimation) return sAnimation;
					else if (eAnimation) return eAnimation;
				} else {
	...
	*/
	...
	_prepareChildren() {
		...
		if (ghostLabel) if (this.get("fixAxisSize")) ghostLabel.set("visible", true);
		else ghostLabel.set("visible", false);
		if (this.isDirty("start") || this.isDirty("end")) {
			const chart = this.chart;
			if (chart) chart._updateCursor();
	...
	*/
	...
	_toggleFHDataItem(dataItem, forceHidden) {
		...
		if (label) label.set(fh, forceHidden);
		const grid = dataItem.get("grid");
		if (grid) grid.set(fh, forceHidden);
		const tick = dataItem.get("tick");
		if (tick) tick.set(fh, forceHidden);
		const axisFill = dataItem.get("axisFill");
		if (axisFill) axisFill.set(fh, forceHidden);
		const bullet = dataItem.get("bullet");
		if (bullet) {
			const sprite = bullet.get("sprite");
			if (sprite) sprite.set(fh, forceHidden);
		}
	}
	_toggleDataItem(dataItem, visible) {
		const label = dataItem.get("label");
		const v = "visible";
		if (label) label.setPrivate(v, visible);
		const grid = dataItem.get("grid");
		if (grid) grid.setPrivate(v, visible);
		const tick = dataItem.get("tick");
		if (tick) tick.setPrivate(v, visible);
		const axisFill = dataItem.get("axisFill");
		if (axisFill) axisFill.setPrivate(v, visible);
		const bullet = dataItem.get("bullet");
		if (bullet) {
			const sprite = bullet.get("sprite");
			if (sprite) sprite.setPrivate(v, visible);
		}
	}
	_createAssets(dataItem, tags, minor) {
		...
		let m = "minor";
		const label = dataItem.get("label");
		if (!label) renderer.makeLabel(dataItem, tags);
		else {
			let themeTags = label.get("themeTags");
			let remove = false;
			if (minor) {
				if ((themeTags === null || themeTags === void 0 ? void 0 : themeTags.indexOf(m)) == -1) remove = true;
			} else if ((themeTags === null || themeTags === void 0 ? void 0 : themeTags.indexOf(m)) != -1) remove = true;
			if (remove) {
				(_a = label.parent) === null || _a === void 0 || _a.children.removeValue(label);
		...
		const grid = dataItem.get("grid");
		if (!grid) renderer.makeGrid(dataItem, tags);
		else {
			...
			if (remove) {
				(_b = grid.parent) === null || _b === void 0 || _b.children.removeValue(grid);
		...
		const tick = dataItem.get("tick");
		if (!tick) renderer.makeTick(dataItem, tags);
		else {
			let remove = false;
			...
			if (remove) {
				(_c = tick.parent) === null || _c === void 0 || _c.children.removeValue(tick);
				renderer.makeTick(dataItem, tags);
				tick.dispose();
				renderer.ticks.removeValue(tick);
			}
		}
		if (!minor && !dataItem.get("axisFill")) renderer.makeAxisFill(dataItem, tags);
		else if (minor && !dataItem.get("axisFill") && this.get("minorAxisFillsEnabled")) renderer.makeAxisFill(dataItem, tags);
	...
	*/
	...
	_updateGhost() {
		...
		if (ghostLabel) {
			if (!ghostLabel.isHidden()) {
				...
				each$1(this.dataItems, (dataItem) => {
					...
					if (label && !label.isHidden()) {
						...
						if (Math.ceil(bounds.right - bounds.left) > gWidth) text = label.text._getText();
					}
				});
			...
			let start = this.get("start", 0);
			let end = this.get("end", 1);
			this.get("renderer").updateLabel(ghostLabel, start + (end - start) * .5);
		}
	}
		...
		if (isNumber(position)) {
			...
			if (tooltip) {
				...
				if (!isNaN(position)) {
					...
					if (position < this.get("start", 0) || position > this.get("end", 1)) tooltip.hide(0);
					else tooltip.show(0);
				} else tooltip.hide(0);
			}
		}
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/ValueAxis.js
/**
...
var ValueAxis = class extends Axis {
	...
	*/
	...
	_prepareChildren() {
		...
		if (this.isDirty("syncWithAxis")) {
			if (this._prevSettings.syncWithAxis) {
				if (this._syncDp) this._syncDp.dispose();
			}
			let syncWithAxis = this.get("syncWithAxis");
			if (syncWithAxis) this._syncDp = new MultiDisposer([syncWithAxis.onPrivate("selectionMinFinal", () => {
				this._dirtySelectionExtremes = true;
		...
		if (this.isDirty("min") || this.isDirty("max") || this.isDirty("maxPrecision") || this.isDirty("numberFormat")) {
			someDirty = true;
			(_a = this.ghostLabel) === null || _a === void 0 || _a.set("text", "");
		}
		...
		if (this._dirtySelectionExtremes && !this._isPanning && this.get("autoZoom", true)) {
			...
			if (chart) {
				...
				if (letter == "Y") chart.xAxes.each((axis) => {
					if (axis.className != "ValueAxis") getMM = true;
				});
				else if (letter == "X") chart.yAxes.each((axis) => {
					if (axis.className != "ValueAxis") getMM = true;
				});
			}
			if (getMM) this._getSelectionMinMax();
	...
	_handleSizeDirty() {
		if (this._sizeDirty && !this._dseHandled) {
			...
			if (this.getPrivate("selectionMinFinal") != this.getPrivate("selectionMin") || this.getPrivate("selectionMaxFinal") != this.getPrivate("selectionMax")) this._dirtySelectionExtremes = false;
		}
	}
	_clearDirty() {
		super._clearDirty();
	...
	_formatText(value) {
		...
		let text = "";
		if (numberFormat) text = formatter.format(value, numberFormat);
		else text = formatter.format(value, void 0, this.getPrivate("stepDecimalPlaces"));
		return text;
	}
	_prepareAxisItems() {
		...
		if (isNumber(min) && isNumber(max)) {
			...
			if (logarithmic) {
				...
				if (minLog <= 0) {
					...
					if (!isNumber(minRealLog)) minRealLog = 1;
					minLog = Math.pow(10, Math.log(minRealLog) * Math.LOG10E);
					if (step < 1) if (isNumber(this._minRealLog)) minLog = this._minRealLog;
					else minLog = Math.pow(10, -50);
				}
				differencePower = Math.log(selectionMax - step) * Math.LOG10E - Math.log(minLog) * Math.LOG10E;
				if (differencePower > 2) value = Math.pow(10, Math.log(minLog) * Math.LOG10E - 50);
			}
			const renderer = this.get("renderer");
			...
			if (round(stepAdjusted / 5, 10) % 1 == 0) minorGridCount = 5;
			if (round(stepAdjusted / 10, 10) % 1 == 0) minorGridCount = 10;
			...
			while (value < selectionMax) {
				...
				this._prepareDataItem(dataItem);
				let nextValue = value;
				if (!logarithmic) nextValue += step;
				else if (differencePower > 2) nextValue = Math.pow(10, Math.log(minLog) * Math.LOG10E + i - 50);
				else nextValue += step;
				if (minorGridEnabled) {
					let minorValue = value + minorStep;
					if (logarithmic) {
						if (differencePower > 2) minorStep = this._adjustMinMax(value, nextValue, 10).step;
					...
					while (minorValue < nextValue - step * 1e-11) {
						...
						} else minorDataItem = this.minorDataItems[m];
						this._createAssets(minorDataItem, ["minor"], true);
						this._toggleDataItem(minorDataItem, true);
						minorDataItem.setRaw("value", minorValue);
						const minorLabel = minorDataItem.get("label");
						if (minorLabel) if (minorLabelsEnabled) minorLabel.set("text", this._formatText(minorValue));
						else minorLabel.setPrivate("visible", false);
			...
			for (let j = i; j < this.dataItems.length; j++) this._toggleDataItem(this.dataItems[j], false);
			for (let j = m; j < this.minorDataItems.length; j++) this._toggleDataItem(this.minorDataItems[j], false);
			each$1(this.series, (series) => {
	...
	_prepareDataItem(dataItem, count) {
		...
		if (dataItem.get("isRange")) {
			if (endValue == null) fillEndPosition = position;
		}
		let labelEndPosition = endPosition;
		let labelEndValue = dataItem.get("labelEndValue");
		if (labelEndValue != null) labelEndPosition = this.valueToPosition(labelEndValue);
	...
	*/
	positionToValue(position) {
		const min = this.getPrivate("min");
		const max = this.getPrivate("max");
		if (!this.get("logarithmic")) return position * (max - min) + min;
		else return Math.pow(Math.E, (position * (Math.log(max) * Math.LOG10E - Math.log(min) * Math.LOG10E) + Math.log(min) * Math.LOG10E) / Math.LOG10E);
	}
	/**
	...
	*/
	valueToPosition(value) {
		const min = this.getPrivate("min");
		const max = this.getPrivate("max");
		if (!this.get("logarithmic")) return (value - min) / (max - min);
		else {
			if (value <= 0) {
	...
	*/
		...
		if (this.get("calculateTotals")) {
			...
			if (series) {
				...
				if (series.dataItems.length > 0) {
					...
					if (field) for (let i = startIndex; i < endIndex; i++) {
						let sum = 0;
						let total = 0;
						each$1(this.series, (series) => {
	...
	_getSelectionMinMax() {
		...
		if (this.get("logarithmic")) {
			if (this.get("extraMin") == null) extraMin = .1;
			if (this.get("extraMax") == null) extraMax = .2;
		}
		const gridCount = this.get("renderer").gridCount();
		...
		if (isNumber(min) && isNumber(max)) {
			...
			each$1(this.series, (series) => {
				if (!series.get("ignoreMinMax")) {
					...
					if (!series.isHidden() && !series.isShowing()) {
						if (isNumber(seriesMin)) selectionMin = Math.min(selectionMin, seriesMin);
						if (isNumber(seriesMax)) selectionMax = Math.max(selectionMax, seriesMax);
					}
				}
			});
			...
			if (selectionMin > selectionMax) [selectionMin, selectionMax] = [selectionMax, selectionMin];
			if (isNumber(minDefined)) if (strictMinMax) selectionMin = minDefined;
			else selectionMin = min;
			else if (strictMinMax) {
				if (isNumber(this._minReal)) selectionMin = this._minReal;
			}
			if (isNumber(maxDefined)) if (strictMinMax) selectionMax = maxDefined;
			else selectionMax = max;
			else if (strictMinMax) {
				if (isNumber(this._maxReal)) selectionMax = this._maxReal;
			}
			...
			if (syncWithAxis) {
				...
				if (minMaxStep.min < min) minMaxStep.min = min;
				if (minMaxStep.max > max) minMaxStep.max = max;
				selectionMin = minMaxStep.min;
				selectionMax = minMaxStep.max;
			}
			if (strictMinMax) {
				if (isNumber(minDefined)) selectionMin = Math.max(selectionMin, minDefined);
				if (isNumber(maxDefined)) selectionMax = Math.min(selectionMax, maxDefined);
			}
			...
			if (strictMinMax) {
				if (isNumber(minDefined)) selectionMin = minDefined;
				else selectionMin = selectionMinReal;
				if (isNumber(maxDefined)) selectionMax = maxDefined;
				else selectionMax = selectionMaxReal;
			...
			if (this.get("logarithmic")) {
				if (selectionMin <= 0) selectionMin = selectionMinReal * (1 - Math.min(extraMin, .99));
				if (selectionMin < min) selectionMin = min;
				if (selectionMax > max) selectionMax = max;
			}
	...
	_getMinMax() {
		...
		if (max - min <= 1 / Math.pow(10, 15)) {
			if (max - min !== 0) this._deltaMinMax = (max - min) / 2;
			else this._getDelta(max);
		...
		if (strictMinMax) {
			if (isNumber(minDefined)) min = minDefined;
			else min = this._minReal;
			if (isNumber(maxDefined)) max = maxDefined;
			else max = this._maxReal;
			if (max - min <= 1e-8) {
				min -= this._deltaMinMax;
				max += this._deltaMinMax;
			}
		...
		if (isNumber(minAdapted)) min = minAdapted;
		if (isNumber(maxAdapted)) max = maxAdapted;
		if (minDiff == Infinity) minDiff = max - min;
	...
	_adjustMinMax(min, max, gridCount, strictMode) {
		...
		if (difference === 0) difference = Math.abs(max);
		...
		if (stepDivisor > 5) stepDivisor = 10;
		else if (stepDivisor <= 5 && stepDivisor > 2) stepDivisor = 5;
		...
		let maxCount;
		if (!strictMode) maxCount = Math.ceil(max / step);
		else maxCount = Math.floor(max / step);
		if (maxCount === minCount) maxCount++;
		max = round(step * maxCount, decCount);
		if (max < initialMax) max = max + step;
		if (min > initialMin) min = min - step;
	...
	*/
	getTooltipText(position, _adjustPosition) {
		...
		if (numberFormat) return formatter.format(value, numberFormat);
		else return formatter.format(value, void 0, decimals);
	}
	/**
	...
	*/
	getSeriesItem(series, position) {
		...
		if (index != null) return series.dataItems[index];
	}
	/**
	...
	*/
	zoomToValues(start, end, duration) {
		...
		if (this.getPrivate("min") != null && this.getPrivate("max") != null) this.zoom((start - min) / (max - min), (end - min) / (max - min), duration);
	}
	/**
	...
	*/
	_checkSync(min, max, step, count) {
		...
		for (let i = 1; i < count; i++) if (round(currentCount / i, 1) == count || currentCount * i == count) return true;
		return false;
	}
	/**
	* Returns relative position between two grid lines of the axis.
	...
	*/
	getCellWidthPosition() {
		...
		if (isNumber(max) && isNumber(min)) return this.getPrivate("step", 1) / (max - min);
		return .05;
	}
	/**
	* @ignore
	*/
	nextPosition(count) {
		...
		if (this.get("renderer").getPrivate("letter") == "Y") count *= -1;
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/CategoryAxis.js
/**
...
* @important
*/
var CategoryAxis = class CategoryAxis extends Axis {
	constructor() {
		super(...arguments);
	...
	_afterDataChange() {
		super._afterDataChange();
		const len = this.dataItems.length;
		if (len > 0) this.setPrivateRaw("maxZoomFactor", len);
	...
	*/
		...
		if (len > 1) {
			...
			if (count <= minZoomCount) {
				...
				for (let i = startIndex; i < len; i++) {
					...
					endIndex = i + 1;
					if (c >= minZoomCount) break;
				}
				if (c < minZoomCount) for (let i = startIndex - 1; i >= 0; i--) {
					const dataItem = this.dataItems[i];
					c += dataItem.get("finalCellSize", 1);
					startIndex = i;
					if (c >= minZoomCount) break;
	...
	_handleRangeChange() {
		each$1(this.series, (series) => {
			...
			if (xAxis instanceof CategoryAxis && yAxis instanceof CategoryAxis) series._markDirtyAxes();
			else if (baseAxis === this) {
				let key;
				let openKey;
				let otherAxis = yAxis;
				if (xAxis === baseAxis) {
					if (series.get("categoryXField")) key = "categoryX";
					if (series.get("openCategoryXField")) openKey = "openCategoryX";
				} else if (yAxis === baseAxis) {
					if (series.get("categoryYField")) key = "categoryY";
					if (series.get("openCategoryYField")) openKey = "openCategoryY";
					otherAxis = xAxis;
				}
					...
					if (key || openKey) {
						...
						function findDataItem(series, categoryAxis, key, openKey, category, direction) {
							...
							while (!dataItem && idx >= 0 && idx < categoryAxis.dataItems.length) {
								...
								if (direction == "previous") for (let i = series.dataItems.length - 1; i >= 0; i--) {
								...
								else for (let i = 0, len = series.dataItems.length; i < len; i++) {
									let item = series.dataItems[i];
									if (key && item.get(key) === searchCategory) {
										dataItem = item;
										break;
								...
								if (!dataItem) idx += direction === "previous" ? -1 : 1;
							}
							return dataItem;
						}
						...
						if (startDataItem) startIndex = series.dataItems.indexOf(startDataItem);
						if (endDataItem) endIndex = series.dataItems.indexOf(endDataItem) + 1;
						...
						for (let i = startIndex; i < endIndex; i++) {
							...
							each$1(series.__valueXShowFields, (key) => {
								if (dataItem.get(key) != null) hasValue = true;
							});
	...
	_prepareAxisItems() {
		...
		for (let j = 0; j < len; j++) this._toggleDataItem(this.dataItems[j], false);
		...
		for (let i = startIndex; i < endIndex; i = i + frequency) {
			...
			this._toggleDataItem(dataItem, true);
			let count = frequency;
			if (minorGridEnabled) count = 1;
			this._prepareDataItem(dataItem, f, count);
			f++;
		}
		if (renderer.get("minorGridEnabled")) for (let i = startIndex; i < endIndex; i++) {
			let dataItem = this.dataItems[i];
			if (i % frequency != 0) {
				this._createAssets(dataItem, ["minor"], true);
				this._toggleDataItem(dataItem, true);
				this._prepareDataItem(dataItem, 0, 1);
				if (!minorLabelsEnabled) (_a = dataItem.get("label")) === null || _a === void 0 || _a.setPrivate("visible", false);
			}
		}
		this._updateGhost();
	}
	_prepareDataItem(dataItem, fillIndex, count) {
		...
		if (!isNumber(index)) index = this.categoryToIndex(dataItem.get("category"));
		let position = this.indexToPosition(index, categoryLocation);
		let endCategory = dataItem.get("endCategory");
		let endIndex;
		if (endCategory) {
			endIndex = this.categoryToIndex(endCategory);
			if (!isNumber(endIndex)) endIndex = index;
		} else endIndex = index;
		...
		renderer.updateBullet(dataItem.get("bullet"), position, endPosition);
		const fillRule = this.get("fillRule");
		if (fillRule) fillRule(dataItem, fillIndex);
	}
	startIndex() {
	...
	*/
	getX(value) {
		...
		if (axisDataItem) return this._settings.renderer.positionToCoordinate(this.indexToPosition(axisDataItem.get("index", 0)));
		return NaN;
	}
	/**
	...
	*/
	getDataItemPositionX(dataItem, field, cellLocation, _axisLocation) {
		...
		if (axisDataItem) return this.indexToPosition(axisDataItem.get("index", 0), cellLocation);
		return NaN;
	}
	/**
	* @ignore
	...
	*/
	indexToPosition(index, location, final) {
		...
		if (!isNumber(location)) location = .5;
		if (!isNumber(index)) return 0;
		...
		if (!final) {
			...
			if (dataItem) position += dataItem.get("deltaPosition", 0);
		}
		return position;
	}
	/**
	...
	*/
	categoryToPosition(category) {
		...
		if (dataItem) return this.indexToPosition(dataItem.get("index"));
		return NaN;
	}
	/**
	...
	*/
	categoryToIndex(category) {
		let dataItem = this._itemMap[category];
		if (dataItem) return dataItem.get("index");
		return NaN;
	}
	/**
	* @ignore
	...
	*/
	roundAxisPosition(position, location) {
		position += (.5 - location) / this.dataItems.length;
	...
	*/
	axisPositionToIndex(position) {
		...
		if (this.get("cellSizeField")) {
			...
			return len - 1;
		} else return fitToRange(Math.floor(position * len), 0, len - 1);
	}
	/**
	* Returns text to be used in an axis tooltip for specific relative position.
	*
	...
	*/
	getTooltipText(position, _adjustPosition) {
		...
		if (dataItem) {
			const label = dataItem.get("label");
			if (label) return populateString(label, this.get("tooltipText", ""));
		}
	}
	_updateTooltipText(tooltip, position) {
	...
	getSeriesItem(series, position) {
		if (this.dataItems.length > 0) {
			...
			if (seriesDataItem && axisDataItem) {
				if (seriesDataItem.get(fieldName) === category) return seriesDataItem;
			}
	...
	*/
	zoomToIndexes(start, end, duration) {
		...
		} else this.zoom(start / len, end / len, duration);
	}
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/AxisLabel.js
/**
* Draws an axis label.
*
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/AxisTick.js
/**
* Draws an axis tick.
*
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/AxisRenderer.js
/**
...
var AxisRenderer = class extends Graphics {
	constructor() {
		...
		*/
		Object.defineProperty(this, "ticks", {
			...
			configurable: true,
			writable: true,
			value: this.addDisposer(new ListTemplate(Template.new({}), () => AxisTick._new(this._root, { themeTags: mergeTags(this.ticks.template.get("themeTags", []), this.get("themeTags", [])) }, [this.ticks.template])))
		});
		/**
		...
		*/
		Object.defineProperty(this, "grid", {
			...
			configurable: true,
			writable: true,
			value: this.addDisposer(new ListTemplate(Template.new({}), () => Grid._new(this._root, { themeTags: mergeTags(this.grid.template.get("themeTags", []), this.get("themeTags", [])) }, [this.grid.template])))
		});
		/**
		...
		*/
		Object.defineProperty(this, "axisFills", {
			...
			configurable: true,
			writable: true,
			value: this.addDisposer(new ListTemplate(Template.new({}), () => Graphics._new(this._root, { themeTags: mergeTags(this.axisFills.template.get("themeTags", ["axis", "fill"]), this.get("themeTags", [])) }, [this.axisFills.template])))
		});
		/**
		...
		*/
		Object.defineProperty(this, "labels", {
			...
			configurable: true,
			writable: true,
			value: this.addDisposer(new ListTemplate(Template.new({}), () => AxisLabel._new(this._root, { themeTags: mergeTags(this.labels.template.get("themeTags", []), this.get("themeTags", [])) }, [this.labels.template])))
		});
		/**
	...
	*/
	makeLabel(dataItem, themeTags) {
		...
		if (dataItem.get("isRange")) this.axis.labelsContainer.children.push(label);
		else this.axis.labelsContainer.children.moveValue(label, 0);
		label._setDataItem(dataItem);
	...
	*/
	...
	_beforeChanged() {
		super._beforeChanged();
		if (this.isDirty("minGridDistance")) this.root.events.once("frameended", () => {
	...
	_changed() {
		...
		if (this.isDirty("pan")) {
			...
			if (thumb) {
				...
				if (pan == "zoom") labelsContainer.children.push(thumb);
				else if (pan == "none") labelsContainer.children.removeValue(thumb);
			}
		}
	}
	...
	*/
	positionToCoordinate(position) {
		if (this._inversed) return (this._end - position) * this._axisLength;
		else return (position - this._start) * this._axisLength;
	}
	/**
	* @ignore
	*/
	...
	*/
	toAxisPosition(position) {
		...
		if (!this.get("inversed")) position = start + position;
		else position = end - position;
		return position;
	}
	/**
	* @ignore
	*/
	toGlobalPosition(position) {
		const start = this._start || 0;
		const end = this._end || 1;
		if (!this.get("inversed")) position = position - start;
		else position = end - position;
		position = position / (end - start);
		return position;
	}
	...
	*/
	...
	toggleVisibility(sprite, position, minPosition, maxPosition) {
		...
		if (position < updatedStart || position > updatedEnd) sprite.setPrivate("visible", false);
		else sprite.setPrivate("visible", true);
	}
	_positionTooltip(tooltip, point) {
		const chart = this.chart;
		if (chart) {
			tooltip.set("pointTo", this._display.toGlobal(point));
			if (!chart.inPlot(point)) tooltip.hide();
		}
	}
	processAxis() {}
};
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/AxisRendererX.js
/**
...
var AxisRendererX = class extends AxisRenderer {
	...
	_changed() {
		...
		if (this.isDirty(opposite) || this.isDirty(inside)) {
			...
			if (this.get(inside)) axis.addTag(inside);
			else axis.removeTag(inside);
			if (chart) {
				if (this.get(opposite)) {
					const children = chart.topAxesContainer.children;
					if (children.indexOf(axis) == -1) children.insertIndex(0, axis);
					axis.addTag(opposite);
					axisChildren.moveValue(this);
				} else {
					const children = chart.bottomAxesContainer.children;
					if (children.indexOf(axis) == -1) children.moveValue(axis);
					axis.removeTag(opposite);
					axisChildren.moveValue(this, 0);
				}
				(_a = axis.ghostLabel) === null || _a === void 0 || _a._applyThemes();
	...
	*/
	_updatePositions() {
		...
		if (chart) {
			...
			let x = axis.x() - width;
			const parent = axis.parent;
			if (parent) x -= parent.get("paddingLeft", 0);
	...
	*/
	processAxis() {
		super.processAxis();
		const axis = this.axis;
		if (axis.get("width") == null) axis.set("width", p100);
	...
	*/
	updateTick(tick, position, endPosition, count) {
		if (tick) {
			...
			let location = .5;
			if (isNumber(count) && count > 1) location = tick.get("multiLocation", location);
			else location = tick.get("location", location);
			if (isNumber(endPosition) && endPosition != position) position = position + (endPosition - position) * location;
	...
	*/
	updateLabel(label, position, endPosition, count) {
		if (label) {
			let location = .5;
			if (isNumber(count) && count > 1) location = label.get("multiLocation", location);
	...
	*/
	updateGrid(grid, position, endPosition) {
		if (grid) {
			if (!isNumber(position)) position = 0;
			let location = grid.get("location", .5);
			if (isNumber(endPosition) && endPosition != position) position = position + (endPosition - position) * location;
	...
	*/
	updateBullet(bullet, position, endPosition) {
		if (bullet) {
			...
			if (sprite) {
				if (!isNumber(position)) position = 0;
				let location = bullet.get("location", .5);
				if (isNumber(endPosition) && endPosition != position) position = position + (endPosition - position) * location;
	...
	*/
	updateTooltipBounds(tooltip) {
		...
		if (!sameBounds(bounds, tooltip.get("bounds"))) {
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/axes/AxisRendererY.js
/**
...
var AxisRendererY = class extends AxisRenderer {
	...
	_changed() {
		...
		if (this.isDirty(opposite) || this.isDirty(inside)) {
			...
			if (chart) {
				if (this.get(opposite)) {
					...
					if (children.indexOf(axis) == -1) children.moveValue(axis, 0);
					axis.addTag(opposite);
					axisChildren.moveValue(this, 0);
				} else {
		...
		if (chart) if (this.get(opposite)) thumb.set("centerX", 0);
		else thumb.set("centerX", w);
	...
	*/
	processAxis() {
		super.processAxis();
		const axis = this.axis;
		if (axis.get("height") == null) axis.set("height", p100);
	...
	*/
	updateLabel(label, position, endPosition, count) {
		if (label) {
			...
			if (opposite) {
				label.set("x", 0);
				if (inside) label.set("position", "absolute");
				else label.set("position", "relative");
			} else if (inside) {
				label.set("x", 0);
				label.set("position", "absolute");
			} else {
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/series/ColumnSeries.js
var ColumnSeries = class extends BaseColumnSeries {
	...
	*/
	makeColumn(dataItem, listTemplate) {
		...
		if (!this.get("turboMode")) this.mainContainer.children.push(column);
		else column.virtualParent = this.chart;
	...
	_afterColumnsDraw() {
		if (this.get("turboMode")) this.allColumns.set("draw", (display) => {
			display.clear();
	...
	_updateChildren() {
		if (this.isDirty("turboMode")) {
			...
			if (!this.get("turboMode")) this.allColumns.set("draw", void 0);
		}
		super._updateChildren();
	}
	_updateSeriesGraphics(dataItem, graphics, l, r, t, b, fitW, fitH) {
		if (this.get("turboMode")) {
			...
			if (!graphics.parent) this.mainContainer.children.push(graphics);
...
//#endregion
//#region node_modules/@amcharts/amcharts5/.internal/charts/xy/series/LineSeries.js
/**
	...
	constructor() {
		...
		*/
		Object.defineProperty(this, "strokes", {
			...
			configurable: true,
			writable: true,
			value: this.addDisposer(new ListTemplate(Template.new({}), () => Graphics._new(this._root, { themeTags: mergeTags(this.strokes.template.get("themeTags", []), [
				"line",
				"series",
				"stroke"
	...
	*/
	...
	_updateChildren() {
		...
		if (this.isDirty("fillPattern")) {
			...
			const legendFill = this._legendFill;
			if (legendFill) legendFill.states.lookup("default").set("fillPattern", fillPattern);
		}
		...
		if (xAxis.inited && yAxis.inited) {
			if (this._axesDirty || this._valuesDirty || this._stackDirty || this.isDirty("vcx") || this.isDirty("vcy") || this._sizeDirty || this.isDirty("connect") || this.isDirty("curveFactory")) {
				...
				this.axisRanges.each((axisRange) => {
					...
					if (fills) fills.each((fill) => {
						fill.setPrivate("visible", false);
					});
					let strokes = axisRange.strokes;
					if (strokes) strokes.each((stroke) => {
						stroke.setPrivate("visible", false);
					});
				});
				let startIndex = this.startIndex();
				...
				for (let i = startIndex - 1; i >= 0; i--) {
					...
					if (strokeTemplateField) {
						if (dataContext[strokeTemplateField]) strokeTemplateFound = true;
					}
					if (fillTemplateField) {
						if (dataContext[fillTemplateField]) fillTemplateFound = true;
					}
					each$1(this._valueFields, (field) => {
				...
				if (len == 1) this._startSegment(0);
				else while (this._dindex < endIndex - 1) {
	...
	_startSegment(dataItemIndex) {
		...
		let baseField;
		if (baseAxis === yAxis) baseField = this._yField;
		else baseField = this._xField;
		const segments = [];
		let points = [];
		segments.push(points);
		const strokeTemplateField = this.strokes.template.get("templateField");
		const fillTemplateField = this.fills.template.get("templateField");
		let locationX = this.get("locationX", .5);
		let locationY = this.get("locationY", .5);
		...
		for (i = dataItemIndex; i < currentEndIndex; i++) {
			...
			if (strokeTemplateField) {
				...
				if (strokeTemplate) {
					if (!(strokeTemplate instanceof Template)) strokeTemplate = Template.new(strokeTemplate);
			...
			if (fillTemplateField) {
				...
				if (fillTemplate) {
					if (!(fillTemplate instanceof Template)) fillTemplate = Template.new(fillTemplate);
		...
		this.axisRanges.each((axisRange) => {
			...
			if (rangeStrokeTemplate && rangeStrokeTemplate != this.strokes.template) stroke.template = rangeStrokeTemplate;
			if (rangeFillTemplate && rangeFillTemplate != this.fills.template) fill.template = rangeFillTemplate;
			stroke.setPrivate("visible", true);
	...
	_getPoints(dataItem, o) {
		...
		if (this._shouldInclude(xPos)) {
			...
			if (o.fillVisible) {
				let xPos0 = xPos;
				let yPos0 = yPos;
				if (o.baseAxis === o.xAxis) yPos0 = o.basePosY;
				else if (o.baseAxis === o.yAxis) xPos0 = o.basePosX;
				if (o.getOpen) {
					...
					if (valueX != null && valueY != null) {
						...
						if (o.stacked) {
							...
							if (stackToItemX) {
								...
								if (isNaN(xPos0)) xPos0 = o.basePosX;
							} else if (o.yAxis === o.baseAxis) xPos0 = o.basePosX;
							else xPos0 = o.xAxis.getDataItemPositionX(dataItem, o.xOpenField, itemLocationX, o.vcx, exactLocationX);
							if (stackToItemY) {
								yPos0 = o.yAxis.getDataItemPositionY(stackToItemY, o.yField, itemLocationY, stackToItemY.component.get("vcy"), exactLocationY);
								if (isNaN(yPos0)) yPos0 = o.basePosY;
							} else if (o.xAxis === o.baseAxis) yPos0 = o.basePosY;
							else yPos0 = o.yAxis.getDataItemPositionY(dataItem, o.yOpenField, itemLocationY, o.vcy, exactLocationY);
						} else {
	...
	_drawStroke(graphics, segments) {
		if (graphics.get("visible") && !graphics.get("forceHidden")) graphics.set("draw", (display) => {
	...
	_processAxisRange(axisRange) {
		super._processAxisRange(axisRange);
		axisRange.fills = new ListTemplate(Template.new({}), () => Graphics._new(this._root, { themeTags: mergeTags(axisRange.fills.template.get("themeTags", []), [
			"line",
			"series",
			"fill"
		]) }, [this.fills.template, axisRange.fills.template]));
		axisRange.strokes = new ListTemplate(Template.new({}), () => Graphics._new(this._root, { themeTags: mergeTags(axisRange.strokes.template.get("themeTags", []), [
			"line",
			"series",
			"stroke"
	...
	*/
	createLegendMarker(_dataItem) {
		...
		if (legendDataItem) {
			...
			const legendFill = marker.children.push(Graphics._new(marker._root, { themeTags: [
				"line",
				"series",
				"legend",
				"marker",
...
//#endregion
export { AxisRendererX as AxisRendererXAm5, AxisRendererY as AxisRendererYAm5, CategoryAxis as CategoryAxisAm5, ColumnSeries as ColumnSeriesAm5, LineSeries as LineSeriesAm5, ValueAxis as ValueAxisAm5, XYChart as XYChartAm5, XYCursor as XYCursorAm5 };

//# sourceMappingURL=xyChart-75_1xNKW.js.map