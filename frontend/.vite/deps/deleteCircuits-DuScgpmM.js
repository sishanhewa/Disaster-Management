...
import { t as p } from "./EditCircuitsResult-NncfukWH.js";
//#region node_modules/@arcgis/core/rest/networks/circuits/deleteCircuits.js
async function c(c, u$1, e) {
	const p$1 = f$1(c), m = u$1.toJSON();
	u$1.circuits && (m.circuits = JSON.stringify(u$1.circuits));
	const n = {
		...m,
		f: "json"
	}, f$2 = s(u({
		...
		method: "post",
		authMode: "no-prompt"
	}), { data: j } = await f(`${p$1.path}/circuits/delete`, f$2);
	return p.fromJSON(j);
}
//#endregion
export { c as deleteCircuits };

//# sourceMappingURL=deleteCircuits-DuScgpmM.js.map