...
import { t } from "./OperatorTouches-Dkujf8zG.js";
//#region node_modules/@arcgis/core/geometry/operators/json/touchesOperator.js
var r = new t();
function n(e, n) {
	const s = Ye(e);
	return r.execute(s.getGeometry(), Ke(n), s.getSpatialReference(), null);
}
//#endregion
export { n as execute };

//# sourceMappingURL=touchesOperator-vdZaJZ3I.js.map