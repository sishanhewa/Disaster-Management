...
import { N as css, O as html, c as nothing, l as safeClassMap, m as ref, p as createRef, r as customElement, s as LitElement } from "./runtime-C8rHe43j.js";
...
//#region node_modules/@esri/calcite-components/dist/chunks/resources.js
var CSS = {
	button: "button",
...
//#endregion
//#region node_modules/@esri/calcite-components/dist/components/calcite-action/customElement.js
...
var Action = class extends LitElement {
	constructor() {
		super(...arguments);
		this.guid = guid();
	...
	renderButton() {
		...
		const ariaControlsElements = [...this.aria?.controlsElements ?? [], ...internalControlsElements];
		if (this.dragHandle) return html`<span .ariaBusy=${loading} .ariaControlsElements=${ariaControlsElements} .ariaDescribedByElements=${this.aria?.describedByElements} .ariaExpanded=${this.aria?.expanded} .ariaHasPopup=${this.aria?.hasPopup} .ariaLabel=${ariaLabel} .ariaLabelledByElements=${this.aria?.labelledByElements} .ariaOwnsElements=${this.aria?.ownsElements} .ariaPressed=${this.aria?.pressed} class=${safeClassMap(buttonClasses)} id=${buttonId ?? nothing} role=button tabindex=${(this.disabled ? null : 0) ?? nothing} ${ref(this.buttonRef)}>${buttonContent}</span>`;
	...
	render() {
		return this.interactiveContainer({
			...
			children: html`${this.renderButton()}${this.renderIndicatorText()}`
		});
	}
};
customElement("calcite-action", Action);
//#endregion
//#region node_modules/@esri/calcite-components/dist/components/calcite-action/index.js
var calcite_action_exports = /* @__PURE__ */ __exportAll({ Action: () => Action });
//#endregion
export { isAction as n, calcite_action_exports as t };

//# sourceMappingURL=calcite-action-BQLn8VGB.js.map