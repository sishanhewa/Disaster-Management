...
//#region node_modules/@arcgis/core/views/2d/layers/features/support/FeatureMetadata.js
var i = class i {
	static minimal(e, n, l = []) {
		return new i({
			geometryType: e,
			fieldsIndex: new _(l).toJSON(),
			featureIdInfo: {
				type: "object-id",
				fieldName: n
			},
	...
	constructor(i) {
		let n;
		this._options = i, this._fieldsIndex = _.fromJSON(i.fieldsIndex), i.spatialReference && (i.spatialReference instanceof S ? this._spatialReference = i.spatialReference : this._spatialReference = S.fromJSON(i.spatialReference)), i.outSpatialReference && (i.outSpatialReference instanceof S ? this._outSpatialReference = i.outSpatialReference : this._outSpatialReference = S.fromJSON(i.outSpatialReference)), "object-id" === i.featureIdInfo.type && (n = i.featureIdInfo.fieldName), this._arcadeSchema = {
			...
			datesInUnknownTimezone: this._options.timeReferenceUnknownClient ?? void 0,
			dateFieldsTimeZone: this._options.dateFieldsTimeZone ?? void 0
		};
	}
	get fieldsIndex() {
	...
	weakCloneWithAdditionalFields(e) {
		return new i({
			fieldsIndex: {
				fields: [...this._fieldsIndex.fields, ...e],
				timeZoneByFieldName: null
			},
			geometryType: this.geometryType,
			globalIdField: this.globalIdField,
			featureIdInfo: this.featureIdInfo,
			...
			dateFieldsTimeZone: this._options.dateFieldsTimeZone,
			typeIdField: this._options.typeIdField,
...
//# sourceMappingURL=FeatureMetadata-BHJp6_d8.js.map