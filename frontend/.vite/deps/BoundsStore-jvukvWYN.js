...
import { o as N } from "./aaBoundingRect-CgUWvAgv.js";
import { t as s } from "./PooledRBush-DcZxtmBy.js";
//#region node_modules/@arcgis/core/layers/graphics/data/BoundsStore.js
var d = 5e4, n = {
	minX: 0,
	minY: 0,
	maxX: 0,
...
var o = class {
	constructor() {
		this._indexInvalid = !1, this._boundsToLoad = [], this._boundsById = /* @__PURE__ */ new Map(), this._idByBounds = /* @__PURE__ */ new Map(), this._index = new s(9, has("esri-csp-restrictions") ? (i) => ({
			minX: i[0],
			minY: i[1],
			maxX: i[2],
			maxY: i[3]
...
//# sourceMappingURL=BoundsStore-jvukvWYN.js.map