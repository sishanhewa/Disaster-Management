...
//#region node_modules/@arcgis/core/symbols/support/previewUtils.js
var t = {
	fill: [{
		type: "path",
...
function l(a) {
	...
	const e = a, m = 4;
	t -= t < 22 ? .5 * m : m;
	const c = 0, p = 0, L = t, n = e, o = Math.floor(a / 10) - 1 || 1;
	return [
		{
			type: "path",
			path: [
...
function u(a, t) {
	return Math.round(Math.min(Math.max(a + 255 * t * .75, 0), 255));
}
function h(t, e) {
	if (null == t) return new g();
...
//#endregion
export { l as a, o as c, t as d, u as f, h as i, p as l, c as n, m as o, e as r, n as s, L as t, s as u };

//# sourceMappingURL=previewUtils-BoKcN8F-.js.map