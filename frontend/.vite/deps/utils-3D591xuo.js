import { r as l$1, t as a$1 } from "./generateRendererUtils-C-FDEpEz.js";
//#region node_modules/@arcgis/core/statistics/utils.js
var t = "<Null>", l = "equal-interval", i = 1, a = 5, o = 10, u = /\s*(\+|-)?((\d+(\.\d+)?)|(\.\d+))\s*/gi, r = new Set([
	"esriFieldTypeDate",
...
]), s = new Set(["esriFieldTypeTimeOnly", "esriFieldTypeDateOnly"]), c = [
	"min",
	"max",
	"avg",
	"stddev",
...
function d(e) {
	const n = null != e.normalizationField || null != e.normalizationType, t = null != e.minValue || null != e.maxValue, l = !!e.sqlExpression && e.supportsSQLExpression;
	return !n && !t && !l;
}
function f(e) {
	const { outStatisticTypes: n } = e, t = e.returnDistinct ? [...new Set(e.values)] : e.values, l = t.filter((e) => null != e).sort(), i = l.length, a = {
		count: i,
		min: l[0],
		max: l[i - 1]
	};
...
function p(e) {
	const { values: n, useSampleStdDev: t, supportsNullCount: l, outStatisticTypes: i } = e;
	let a = Number.POSITIVE_INFINITY, o = Number.NEGATIVE_INFINITY, u = null, r = null, s = null, c = null, m = 0;
	const d = null == e.minValue ? -Infinity : e.minValue, f = null == e.maxValue ? Infinity : e.maxValue;
...
function v(e, n) {
	const { fieldType: t, value: l, orderBy: i, isDiscrete: a } = n, o = g(t, "desc" === i, "case-insensitive");
	if (0 === (e = [...e].filter((e) => null != e).sort((e, n) => o(e, n))).length) return null;
	if (l <= 0) return e[0];
	if (l >= 1) return e[e.length - 1];
	const u = (e.length - 1) * l, r = Math.floor(u), s = r + 1, c = u % 1, m = e[r], d = e[s];
	return s >= e.length || a || "string" == typeof m || "string" == typeof d ? m : m * (1 - c) + d * c;
}
function g(e, n, t = "case-sensitive") {
	if (e) {
		if (r.has(e)) return N(n);
		if (s.has(e)) return D(n, !0);
		if ("esriFieldTypeTimestampOffset" === e) return F(n);
		const l = D(n, "case-sensitive" === t);
		if ("esriFieldTypeString" === e) return l;
		if ("esriFieldTypeGUID" === e || "esriFieldTypeGlobalID" === e) return (e, n) => l(M(e), M(n));
	}
	const l = n ? 1 : -1, i = N(n), a = D(n, "case-sensitive" === t), o = x(n);
	return (e, n) => "number" == typeof e && "number" == typeof n ? i(e, n) : "string" == typeof e && "string" == typeof n ? a(e, n) : o(e, n) ?? l;
}
var h = (e, n) => null == e ? null == n ? 0 : 1 : null == n ? -1 : null, T = (e, n) => null == e ? null == n ? 0 : -1 : null == n ? 1 : null;
function x(e) {
	return e ? h : T;
}
var y = (e, n) => T(e, n) ?? (e === n ? 0 : new Date(e).getTime() - new Date(n).getTime()), V = (e, n) => h(e, n) ?? (e === n ? 0 : new Date(n).getTime() - new Date(e).getTime());
function F(e) {
	return e ? V : y;
}
var I = (e, n) => T(e, n) ?? (e === n ? 0 : e < n ? -1 : 1), b = (e, n) => h(e, n) ?? (e === n ? 0 : e < n ? 1 : -1);
function D(e, n) {
	if (n) return e ? b : I;
	const t = x(e);
	return e ? (e, n) => {
...
var z = (e, n) => h(e, n) ?? n - e, S = (e, n) => T(e, n) ?? e - n;
function N(e) {
	return e ? z : S;
}
function M(e) {
...
function E(e, t, l) {
	...
	return e = O(e, t.minValue, t.maxValue), a$1({
		definition: i,
		values: e,
...
function O(e, n, t) {
	const l = n ?? -Infinity, i = t ?? Infinity;
	return e.filter((e) => Number.isFinite(e) && e >= l && e <= i);
}
function q(n) {
	const { breakCount: t, field: a, normalizationField: o, normalizationType: u } = n, r = n.classificationMethod || l, s = "standard-deviation" === r ? n.standardDeviationInterval || i : void 0, c = "defined-interval" === r ? n.definedInterval : void 0;
	return new l$1({
		breakCount: t,
...
function P(e, n) {
	let t = e.classBreaks;
	const l = t.length, i = t[0]?.minValue, a = t[l - 1]?.maxValue, o = "standard-deviation" === n, r = u;
	return t = t.map((e) => {
		const n = e.label, t = {
			minValue: e.minValue,
			maxValue: e.maxValue,
		...
		if (o && n) {
			const l = n.match(r)?.map((e) => +e.trim()) ?? [];
...
function U(e, n) {
	...
	const l = t.intervals, i = t.min ?? 0, a = t.max ?? 0, o = l.map((e, n) => ({
		minValue: l[n][0],
		maxValue: l[n][1],
		count: 0
	}));
...
function G(e, n, t = !1) {
	const { field: l, classificationMethod: i, standardDeviationInterval: a, definedInterval: u, normalizationType: r, normalizationField: s, normalizationTotal: c, minValue: m, maxValue: f } = n, v = n.numBins || o;
	let g = null, h = null, T = null;
	if ((!i || "equal-interval" === i) && !r) {
		if (null != m && null != f) g = m, h = f;
		else {
			const n = p({
				values: e,
				minValue: m,
...
function L(e, n) {
	let t = -1;
	for (let l = e.length - 1; l >= 0; l--) if (n >= e[l][0]) {
		t = l;
		break;
	}
	return t;
...
//#endregion
export { q as _, G as a, U as c, f as d, g as f, p as g, m as h, E as i, c as l, k as m, B as n, L as o, j as p, C as r, P as s, $ as t, d as u, v };

//# sourceMappingURL=utils-3D591xuo.js.map