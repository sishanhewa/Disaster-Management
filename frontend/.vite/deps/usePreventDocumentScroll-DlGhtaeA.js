import { n as makeGenericController, t as makeController } from "./controllers-2rrOeKHA.js";
//#region node_modules/@esri/calcite-components/dist/chunks/useSizeOverride.js
...
function requireInteract_min() {
	...
	(function(module, exports) {
		(function(t, e) {
			...
			function a(t2, e2, n2) {
				return (e2 = d(e2)) in t2 ? Object.defineProperty(t2, e2, {
					value: n2,
					enumerable: true,
					configurable: true,
					writable: true
			...
			function s(t2, e2) {
				...
				t2.prototype = Object.create(e2 && e2.prototype, { constructor: {
					...
					writable: true,
					configurable: true
				} }), Object.defineProperty(t2, "prototype", { writable: false }), e2 && l(t2, e2);
			}
			function c(t2) {
			...
			var S = {
				...
				listeners: {
					...
					"auto-start:check": function(t2) {
						...
						if (i2 && i2.enabled && (!e2.pointerIsDown || !/mouse|pointer/.test(e2.pointerType) || 0 != (r2 & n2.options.drag.mouseButtons))) return t2.action = {
							name: "drag",
							axis: "start" === i2.lockAxis ? i2.startAxis : i2.lockAxis
						}, false;
					}
				},
			...
			function Y(t2) {
				...
				return e2 && {
					...
					top: e2.top,
					bottom: e2.bottom,
					width: e2.width || e2.right - e2.left,
					height: e2.height || e2.bottom - e2.top
				};
			}
			function L(t2) {
				var e2, n2 = Y(t2);
				if (!I.isIOS7 && n2) {
					var r2 = {
						x: (e2 = (e2 = y(t2)) || g).scrollX || e2.document.documentElement.scrollLeft,
						y: e2.scrollY || e2.document.documentElement.scrollTop
					};
			...
			function N(t2) {
				return t2 && {
					x: "x" in t2 ? t2.x : t2.left,
					y: "y" in t2 ? t2.y : t2.top
				};
			}
			function U(t2) {
			...
			function K(t2, e2, n2) {
				...
				return N(G(r2 && r2.origin || t2.options.origin, t2, e2, [t2 && e2])) || {
					x: 0,
					y: 0
				};
			}
			function $(t2, e2) {
				...
				else if (w.object(e2)) for (var s2 in e2) $(J(s2).map((function(e3) {
			...
			function tt(t2, e2) {
				...
				var n2 = function(n3) {
					...
					"function" != typeof t2[n3] && "__set" !== n3 && Object.defineProperty(t2, n3, {
						get: function() {
			...
			function ot(t2, e2) {
				return e2 = e2 || {
					x: 0,
					y: 0
				}, I.isOperaMobile && rt(t2) ? (it("screen", t2, e2), e2.x += window.scrollX, e2.y += window.scrollY) : it("page", t2, e2), e2;
			}
			function at(t2) {
			...
			function pt(t2, e2) {
				var n2 = e2 + "X", r2 = e2 + "Y", i2 = ct(t2);
				return Q(i2[0][n2] - i2[1][n2], i2[0][r2] - i2[1][r2]);
			}
			function ft(t2, e2) {
			...
			function dt(t2) {
				return w.string(t2.pointerType) ? t2.pointerType : w.number(t2.pointerType) ? [
					void 0,
					void 0,
					"touch",
					"pen",
					"mouse"
				][t2.pointerType] : /touch/.test(t2.type || "") || t2 instanceof k.Touch ? "touch" : "mouse";
			}
			function ht(t2) {
				...
				for (var n2 = (function(t3, e3) {
					for (var n3 = [], r3 = 0, i3 = t3.interactables.list; r3 < i3.length; r3++) {
						...
						if (o2.options.drop.enabled) {
							...
							if (!(w.element(a2) && a2 !== e3 || w.string(a2) && !R(e3, a2) || w.func(a2) && !a2({
								dropzone: o2,
								draggableElement: e3
				...
				install: function(t2) {
					...
					t2.usePlugin(_), r2.prototype.dropzone = function(t3) {
						...
						return (function(t4, e4, n4, r4, i4, o3, a2) {
							...
							if (d2 && w.number(c2)) s2 = Math.max(0, Math.min(a2.right, d2.right) - Math.max(a2.left, d2.left)) * Math.max(0, Math.min(a2.bottom, d2.bottom) - Math.max(a2.top, d2.top)) / (d2.width * d2.height) >= c2;
						...
						dropmove: true,
						drop: true
					}), e2.methodDict.drop = "dropzone", t2.dynamicDrop = false, i2.actions.drop = Ot.defaults;
				},
				listeners: {
					"interactions:before-action-start": function(t2) {
						var e2 = t2.interaction;
						"drag" === e2.prepared.name && (e2.dropState = {
							cur: {
								dropzone: null,
								element: null
							},
					...
					"interactions:after-action-start": function(t2, e2) {
						...
						if ("drag" === n2.prepared.name) {
							var i2 = n2.dropState;
							i2.activeDrops = [], i2.events = {}, i2.activeDrops = Et(e2, n2.element), i2.events = St(n2, 0, r2), i2.events.activate && (wt(i2.activeDrops, i2.events.activate), e2.fire("actions/drop:start", {
								interaction: n2,
								dragEvent: r2
							}));
						}
					...
					"interactions:after-action-move": function(t2, e2) {
						var n2 = t2.interaction, r2 = t2.iEvent;
						if ("drag" === n2.prepared.name) {
							var i2 = n2.dropState;
							_t(n2, i2.events), e2.fire("actions/drop:move", {
								interaction: n2,
								dragEvent: r2
							}), i2.events = {};
						}
					...
					"interactions:action-end": function(t2, e2) {
						if ("drag" === t2.interaction.prepared.name) {
							var n2 = t2.interaction, r2 = t2.iEvent;
							Pt(t2, e2), _t(n2, n2.dropState.events), e2.fire("actions/drop:end", {
								interaction: n2,
								dragEvent: r2
							});
						}
			...
			function Dt(t2) {
				...
				if ("gesture" === e2.prepared.name) {
					...
					e2.gesture.distance = n2.distance, e2.gesture.angle = n2.angle, w.number(n2.scale) && n2.scale !== Infinity && !isNaN(n2.scale) && (e2.gesture.scale = n2.scale);
				}
			}
			var It = {
				id: "actions/gesture",
				...
				listeners: {
					...
					"interactions:new": function(t2) {
						t2.interaction.gesture = {
							angle: 0,
							distance: 0,
							scale: 1,
							startAngle: 0,
						...
						if (i2) {
							...
							if (s2 && s2.enabled && (!e2.pointerIsDown || !/mouse|pointer/.test(e2.pointerType) || 0 != (o2 & s2.mouseButtons))) {
								if (w.object(s2.edges)) {
									...
									c2.left = c2.left && !c2.right, c2.top = c2.top && !c2.bottom, (c2.left || c2.right || c2.top || c2.bottom) && (t2.action = {
										name: "resize",
										edges: c2
									});
								} else {
			...
			var Lt = {
				...
				init: function(t2) {
					if (Rt = t2.requestAnimationFrame, Ct = t2.cancelAnimationFrame, !Rt) for (var e2 = [
						"ms",
						"moz",
						"webkit",
						"o"
			...
			function Vt(t2) {
				return w.window(t2) && (t2 = window.document.body), {
					x: t2.scrollLeft,
					y: t2.scrollTop
				};
			}
			...
			var ae = {
				...
				install: function(t2) {
					...
					t2.usePlugin($t), n2.base.actionChecker = null, n2.base.styleCursor = true, V(n2.perAction, {
						manualStart: false,
						max: Infinity,
						maxPerElement: 1,
						allowFrom: null,
						ignoreFrom: null,
						mouseButtons: 1
					}), e2.maxInteractions = function(e3) {
						return ne(e3, t2);
					}, t2.autoStart = {
			...
			var se = {
				...
				listeners: { "autoStart:before-start": function(t2, e2) {
			...
			var he = {
				...
				install: function(t2) {
					...
					}, t2.interactions.docEvents.push({
						type: "dragstart",
						listener: function(e3) {
			...
			var me = (function() {
				function t2(e2) {
					r(this, t2), this.states = [], this.startOffset = {
						left: 0,
						right: 0,
						top: 0,
						bottom: 0
					}, this.startDelta = void 0, this.result = void 0, this.endResult = void 0, this.startEdges = void 0, this.edges = void 0, this.interaction = void 0, this.interaction = e2, this.result = ye(), this.edges = {
						left: false,
						right: false,
						top: false,
						bottom: false
				...
				return o(t2, [
					{
						...
						value: function(t3, e2) {
							...
							this.prepareStates(a2), this.startEdges = V({}, o2.edges), this.edges = V({}, this.startEdges), this.startOffset = (n2 = o2.rect, r2 = e2, n2 ? {
								left: r2.x - n2.left,
								top: r2.y - n2.top,
								right: n2.right - r2.x,
								bottom: n2.bottom - r2.y
							} : {
								left: 0,
								top: 0,
								right: 0,
					...
					},
					{
						...
						value: function(t3) {
							...
							for (var a2 = r2 ? this.states.slice(r2) : this.states, s2 = ye(t3.coords, t3.rect), c2 = 0; c2 < a2.length; c2++) {
								...
								null != (l2 = u2.methods) && l2.set && this.shouldDo(p2, n2, e2) && (t3.state = u2, d2 = u2.methods.set(t3), H(t3.edges, t3.rect, {
									x: t3.coords.x - f2.x,
									y: t3.coords.y - f2.y
								})), s2.eventProps.push(d2);
							}
							...
							if (h2 && v2) s2.changed = s2.rect.left !== v2.left || s2.rect.right !== v2.right || s2.rect.top !== v2.top || s2.rect.bottom !== v2.bottom || h2.x !== s2.coords.x || h2.y !== s2.coords.y;
							return s2;
						}
					},
					{
					...
					},
					{
						key: "setAndApply",
						value: function(t3) {
							var e2 = this.interaction, n2 = t3.phase, r2 = t3.preEnd, i2 = t3.skipModifiers, o2 = this.setAll(this.fillArg({
								preEnd: r2,
								phase: n2,
								pageCoords: t3.modifiedCoords || e2.coords.cur.page
							}));
							if (this.result = o2, !o2.changed && (!i2 || i2 < this.states.length) && e2.interacting()) return false;
							if (t3.modifiedCoords) {
								var a2 = e2.coords.cur.page, s2 = {
									x: t3.modifiedCoords.x - a2.x,
									y: t3.modifiedCoords.y - a2.y
								};
			...
			function be(t2, e2) {
				var n2 = t2.defaults, r2 = {
					start: t2.start,
					set: t2.set,
					beforeEnd: t2.beforeEnd,
					stop: t2.stop
				}, i2 = function(t3) {
					var i3 = t3 || {};
			...
			var Ee = {
				...
				listeners: {
					...
					"interactions:after-action-start": function(t2) {
				...
				function n2(t3, i2, o2, a2, s2, c2, l2) {
					...
					var f2 = t3.interactable, d2 = (f2 && f2.options || Te).deltaSource, h2 = K(f2, s2, o2), v2 = "start" === a2, g2 = "end" === a2, m2 = v2 ? u(p2) : t3.prevEvent, y2 = v2 ? t3.coords.start : g2 ? {
						page: m2.page,
						client: m2.client,
						timeStamp: t3.coords.cur.timeStamp
					} : t3.coords.cur;
					return p2.page = V({}, y2.page), p2.client = V({}, y2.client), p2.rect = V({}, t3.rect), p2.timeStamp = y2.timeStamp, g2 || (p2.page.x -= h2.x, p2.page.y -= h2.y, p2.client.x -= h2.x, p2.client.y -= h2.y), p2.ctrlKey = i2.ctrlKey, p2.altKey = i2.altKey, p2.shiftKey = i2.shiftKey, p2.metaKey = i2.metaKey, p2.button = i2.button, p2.buttons = i2.buttons, p2.target = s2, p2.currentTarget = s2, p2.preEnd = c2, p2.type = l2 || o2 + (a2 || ""), p2.interactable = f2, p2.t0 = v2 ? t3.pointers[t3.pointers.length - 1].downTime : m2.t0, p2.x0 = t3.coords.start.page.x - h2.x, p2.y0 = t3.coords.start.page.y - h2.y, p2.clientX0 = t3.coords.start.client.x - h2.x, p2.clientY0 = t3.coords.start.client.y - h2.y, p2.delta = v2 || g2 ? {
						x: 0,
						y: 0
					} : {
						x: p2[d2].x - m2[d2].x,
						y: p2[d2].y - m2[d2].y
					}, p2.dt = t3.coords.delta.timeStamp, p2.duration = p2.timeStamp - p2.t0, p2.velocity = V({}, t3.coords.velocity[d2]), p2.speed = Q(p2.velocity.x, p2.velocity.y), p2.swipe = g2 || "inertiastart" === a2 ? p2.getSwipe() : null, p2;
				}
				return o(n2, [
					{
						key: "getSwipe",
						value: function() {
							...
							return {
								up: r2,
								down: !r2 && 22.5 <= e3 && e3 < 157.5,
								left: n3,
								right: !n3 && (292.5 <= e3 || e3 < 67.5),
								angle: e3,
								speed: t3.prevEvent.speed,
								velocity: {
									x: t3.prevEvent.velocityX,
									y: t3.prevEvent.velocityY
								}
							};
						}
					},
			...
			var _e = o((function t2(e2, n2, i2, o2, a2) {
				...
				function t2(e2) {
					...
					r(this, t2), this.interactable = null, this.element = null, this.rect = null, this._rects = void 0, this.edges = null, this._scopeFire = void 0, this.prepared = {
						name: null,
						axis: null,
						edges: null
						...
						event: null,
						eventTarget: null
					}, this.prevEvent = null, this.pointerIsDown = false, this.pointerWasMoved = false, this._interacting = false, this._ending = false, this._stopped = true, this._proxy = void 0, this.simulation = null, this.doMove = Nt((function(t3) {
						this.move(t3);
					...
					}, this._id = ke++, this._scopeFire = o2, this.pointerType = i2;
					var a2 = this;
					this._proxy = {};
					var s2 = function(t3) {
				...
				return o(t2, [
					...
					},
					{
						key: "start",
						value: function(t3, e2, n2) {
							return !(this.interacting() || !this.pointerIsDown || this.pointers.length < ("gesture" === t3.name ? 2 : 1) || !e2.options[t3.name].enabled) && (Ut(this.prepared, t3), this.interactable = e2, this.element = n2, this.rect = e2.getRect(n2), this.edges = this.prepared.edges ? V({}, this.prepared.edges) : {
								left: true,
								right: true,
								top: true,
								bottom: true
					...
					},
					{
						...
						value: function(t3, e2, n2) {
							...
							var a2, s2, c2, l2 = this.getPointerIndex(t3), u2 = {
								pointer: t3,
								pointerIndex: l2,
								pointerInfo: this.pointers[l2],
								event: e2,
								type: "move",
								eventTarget: n2,
								dx: r2,
					...
					},
					{
						...
						value: function(t3, e2, n2, r2) {
							...
							this._scopeFire("interactions:".concat(o2), {
								pointer: t3,
								pointerIndex: i2,
								pointerInfo: this.pointers[i2],
								event: e2,
								eventTarget: n2,
								type: o2,
								curEventTarget: r2,
								interaction: this
							}), this.simulation || this.end(e2), this.removePointer(t3, e2);
						}
					},
					{
						key: "documentBlur",
						value: function(t3) {
							this.end(t3), this._scopeFire("interactions:blur", {
								event: t3,
								type: "blur",
								interaction: this
							});
					...
					},
					{
						...
						value: function(t3) {
							var e2;
							this._ending = true, t3 = t3 || this._latestPointer.event, this.interacting() && (e2 = this._doPhase({
								event: t3,
								interaction: this,
								phase: "end"
							})), this._ending = false, true === e2 && this.stop();
						}
					},
					{
						key: "currentAction",
						...
						value: function(t3, e2) {
							...
							if (-1 !== n2) {
								...
								this._scopeFire("interactions:remove-pointer", {
									...
									pointerInfo: r2,
									interaction: this
								}), this.pointers.splice(n2, 1), this.pointerIsDown = false;
							}
						}
					},
					{
				...
				return o(t2, [
					{
						...
						value: function(t3) {
							...
							if (o2.copyFrom(e2.modification), this.t0 = e2._now(), this.allowResume = n2.allowResume, this.v0 = i2, this.currentOffset = {
								x: 0,
								y: 0
							}, this.startCoords = e2.coords.cur.page, this.modifierArg = o2.fillArg({
								pageCoords: this.startCoords,
								preEnd: true,
								phase: "inertiastart"
							}), this.t0 - e2.coords.cur.timeStamp < 50 && i2 > n2.minSpeed && i2 > n2.endSpeed) this.startInertia();
							else {
								if (o2.result = o2.setAll(this.modifierArg), !o2.result.changed) return false;
								this.startSmoothEnd();
							}
							return e2.modification.result.rect = null, e2.offsetBy(this.targetOffset), e2._doPhase({
								interaction: e2,
								event: t3,
								phase: "inertiastart"
							}), e2.offsetBy({
							...
							}), e2.modification.result.rect = null, this.active = true, e2.simulation = this, true;
						}
					},
					{
						key: "startInertia",
						value: function() {
							...
							this.targetOffset = {
								x: (e2.x - i2) / r2,
								y: (e2.y - i2) / r2
							}, this.te = i2, this.lambda_v0 = r2 / this.v0, this.one_ve_v0 = 1 - n2.endSpeed / this.v0;
							var o2 = this.modification, a2 = this.modifierArg;
							a2.pageCoords = {
								x: this.startCoords.x + this.targetOffset.x,
								y: this.startCoords.y + this.targetOffset.y
							}, o2.result = o2.setAll(a2), o2.result.changed && (this.isModified = true, this.modifiedOffset = {
								x: this.targetOffset.x + o2.result.delta.x,
								y: this.targetOffset.y + o2.result.delta.y
					...
					},
					{
						...
						value: function() {
							var t3 = this;
							this.smoothEnd = true, this.isModified = true, this.targetOffset = {
					...
					},
					{
						...
						value: function() {
							...
							if (u2 < this.te) {
								...
								this.isModified ? (t3 = 0, e2 = 0, n2 = this.targetOffset.x, r2 = this.targetOffset.y, i2 = this.modifiedOffset.x, o2 = this.modifiedOffset.y, p2 = {
									x: Ye(a2 = f2, t3, n2, i2),
									y: Ye(a2, e2, r2, o2)
								}) : p2 = {
									x: this.targetOffset.x * f2,
									y: this.targetOffset.y * f2
								};
								var d2 = {
									x: p2.x - this.currentOffset.x,
									y: p2.y - this.currentOffset.y
								};
					...
					},
					{
						...
						value: function() {
							...
							if (n2 < r2) {
								var i2 = {
									x: Le(n2, 0, this.targetOffset.x, r2),
									y: Le(n2, 0, this.targetOffset.y, r2)
								}, o2 = {
									x: i2.x - this.currentOffset.x,
									y: i2.y - this.currentOffset.y
								};
					...
					},
					{
						...
						value: function(t3) {
							...
							}), i2.updatePointer(e2, n2, r2, true), i2._doPhase({
								interaction: i2,
								event: n2,
								phase: "resume"
							}), et(i2.coords.prev, i2.coords.cur), this.stop();
						}
					},
					{
						key: "end",
			...
			var Xe = {
				...
				install: function(t2) {
					var e2 = t2.defaults;
					t2.usePlugin(Ce), t2.usePlugin(Ee), t2.actions.phases.inertiastart = true, t2.actions.phases.resume = true, e2.perAction.inertia = {
						enabled: false,
						resistance: 10,
						minSpeed: 100,
						endSpeed: 10,
				...
				listeners: {
					...
					"interactions:after-action-inertiastart": function(t2) {
						return t2.interaction.modification.restoreInteractionCoords(t2);
					},
			...
			var Ue = {
				...
				install: function(t2) {
					var e2, n2 = [], r2 = {}, i2 = [], o2 = {
						add: a2,
						remove: s2,
						addDelegate: function(t3, e3, n3, o3, s3) {
							var u2 = Ge(s3);
							if (!r2[n3]) {
								r2[n3] = [];
					...
					function a2(t3, e3, r3, i3) {
						if (t3.addEventListener) {
							...
							s3 || (s3 = {
								eventTarget: t3,
								events: {}
							}, n2.push(s3)), s3.events[e3] || (s3.events[e3] = []), bt(s3.events[e3], (function(t4) {
								return t4.func === r3 && Ne(t4.options, a3);
							})) || (t3.addEventListener(e3, r3, o2.supportsOptions ? a3 : a3.capture), s3.events[e3].push({
								func: r3,
								options: a3
							}));
						}
					...
					return null == (e2 = t2.document) || e2.createElement("div").addEventListener("test", null, {
						get capture() {
			...
			function Ze(t2) {
				var e2 = t2.pointerType, n2 = t2.scope, r2 = {
					interaction: $e.search(t2),
					searchDetails: t2
				};
			...
			var nn = {
				...
				install: function(t2) {
					...
					(a2 = k.PointerEvent ? [
						...
						{
							type: c2.down,
							listener: e2.pointerDown
						},
						{
							type: c2.move,
							listener: e2.pointerMove
						},
						{
							type: c2.up,
							listener: e2.pointerUp
						},
						{
							type: c2.cancel,
							listener: e2.pointerUp
						...
						type: "blur",
						listener: function(e3) {
							for (var n3 = 0, r2 = t2.interactions.list; n3 < r2.length; n3++) r2[n3].documentBlur(e3);
						}
				...
				listeners: {
					"scope:add-document": function(t2) {
						return tn(t2, "add");
					},
				...
				return o(t2, [
					{
						...
						value: function(t3, e2) {
							...
							return this.scope.addDocument(n2._doc), this.list.push(n2), w.string(t3) ? (this.selectorMap[t3] || (this.selectorMap[t3] = []), this.selectorMap[t3].push(n2)) : (n2.target[this.scope.id] || Object.defineProperty(t3, this.scope.id, {
								value: [],
								configurable: true
							}), t3[this.scope.id].push(n2)), this.scope.fire("interactable:new", {
								target: t3,
								options: e2,
								interactable: n2,
								win: this.scope._win
			...
			var sn = (function() {
				function t2() {
					var e2 = this;
					r(this, t2), this.id = "__interact_scope_".concat(Math.floor(100 * Math.random())), this.isInitialized = false, this.listenerMaps = [], this.browser = I, this.defaults = ge(Te), this.Eventable = Ve, this.actions = {
						map: {},
						phases: {
							start: true,
							move: true,
						...
						methodDict: {},
						phaselessTypes: {}
					}, this.interactStatic = (function(t3) {
						...
						list: [],
						map: {}
					}, this.onWindowUnload = function(t3) {
					...
					this.Interactable = (function(t3) {
						...
						return o(i2, [
							...
							},
							{
								key: "set",
								value: function(t4) {
									return f(c(i2.prototype), "set", this).call(this, t4), n2.fire("interactable:set", {
										options: t4,
										interactable: this
									}), this;
								}
				...
				return o(t2, [
					...
					},
					{
						...
						value: function(t3, e2) {
							...
							if (t3.id && (this._plugins.map[t3.id] = t3), this._plugins.list.push(t3), t3.install && t3.install(this, e2), t3.listeners && t3.before) {
								...
								this.listenerMaps.splice(n2, 0, {
									id: t3.id,
									map: t3.listeners
								});
							} else t3.listeners && this.listenerMaps.push({
								id: t3.id,
								map: t3.listeners
							});
							return this;
					...
					},
					{
						...
						value: function(t3, e2) {
							...
							var n2 = y(t3);
							e2 = e2 ? V({}, e2) : {}, this.documents.push({
								doc: t3,
								options: e2
							}), this.events.documents.push(t3), t3 !== this.document && this.events.add(n2, "unload", this.onWindowUnload), this.fire("scope:add-document", {
								doc: t3,
								window: n2,
								scope: this,
								options: e2
					...
					},
					{
						...
						value: function(t3) {
							...
							this.events.remove(n2, "unload", this.onWindowUnload), this.documents.splice(e2, 1), this.events.documents.splice(e2, 1), this.fire("scope:remove-document", {
								doc: t3,
								window: n2,
								scope: this,
								options: r2
			...
			var fn = Object.freeze({
				...
				grid: function(t2) {
					var e2 = [
						...
						for (var i2 = t2.range, o2 = t2.limits, a2 = void 0 === o2 ? {
							left: -Infinity,
							right: Infinity,
							top: -Infinity,
							bottom: Infinity
						} : o2, s2 = t2.offset, c2 = void 0 === s2 ? {
							x: 0,
							y: 0
						} : s2, l2 = {
							range: i2,
				...
				start: function(t2) {
					...
					var f2 = n2.linkedEdges = {
						top: i2.top || i2.left && !i2.bottom,
						left: i2.left || i2.top && !i2.right,
						bottom: i2.bottom || i2.right && !i2.top,
						right: i2.right || i2.bottom && !i2.left
					};
				...
				set: function(t2) {
					...
					var l2 = n2.subModification.setAll(e(e({}, t2), {}, {
						rect: c2,
						edges: o2,
						pageCoords: i2,
						prevCoords: i2,
			...
			function wn(t2, e2, n2) {
				return w.func(t2) ? G(t2, e2.interactable, e2.element, [
					n2.x,
					n2.y,
					e2
				]) : G(t2, e2.interactable, e2.element);
			}
			var En = {
				start: function(t2) {
					var e2 = t2.rect, n2 = t2.startOffset, r2 = t2.state, i2 = t2.interaction, o2 = t2.pageCoords, a2 = r2.options, s2 = a2.elementRect, c2 = V({
						left: 0,
						top: 0,
						right: 0,
						bottom: 0
			...
			var On = {
				...
				start: function(t2) {
					...
					o2 && (e2 = N(wn(o2.offset, n2, n2.coords.start.page))), e2 = e2 || {
						x: 0,
						y: 0
					}, i2.offset = {
						top: e2.y + r2.top,
						left: e2.x + r2.left,
						bottom: e2.y - r2.bottom,
						right: e2.x - r2.right
					};
				},
				set: function(t2) {
				...
				set: function(t2) {
					...
					if (i2) {
						...
						n2.options = {
							...
							inner: V({}, On.noInner),
							outer: V({}, On.noOuter)
						}, i2.top ? (n2.options.inner.top = r2.bottom - a2.height, n2.options.outer.top = r2.bottom - s2.height) : i2.bottom && (n2.options.inner.bottom = r2.top + a2.height, n2.options.outer.bottom = r2.top + s2.height), i2.left ? (n2.options.inner.left = r2.right - a2.width, n2.options.outer.left = r2.right - s2.width) : i2.right && (n2.options.inner.right = r2.left + a2.width, n2.options.outer.right = r2.left + s2.width), On.set(t2), n2.options = o2;
					}
				},
				defaults: {
					min: null,
			...
			var Rn = {
				start: function(t2) {
					var e2, n2 = t2.interaction, r2 = t2.interactable, i2 = t2.element, o2 = t2.rect, a2 = t2.state, s2 = t2.startOffset, c2 = a2.options, l2 = c2.offsetWithOrigin ? (function(t3) {
						...
						return N(G(t3.state.options.origin, null, null, [e3])) || K(t3.interactable, e3, t3.interaction.prepared.name);
					})(t2) : {
						x: 0,
						y: 0
					};
					if ("startCoords" === c2.offset) e2 = {
						x: n2.coords.start.page.x,
						y: n2.coords.start.page.y
					};
					else {
					...
					a2.offsets = o2 && p2 && p2.length ? p2.map((function(t3, n3) {
						return {
							index: n3,
							relativePoint: t3,
							x: s2.left - o2.width * t3.x + e2.x,
							y: s2.top - o2.height * t3.y + e2.y
						};
					})) : [{
						index: 0,
						relativePoint: null,
				...
				set: function(t2) {
					...
					for (var l2 = 0, u2 = o2; l2 < u2.length; l2++) for (var p2 = u2[l2], f2 = s2.x - p2.x, d2 = s2.y - p2.y, h2 = 0, v2 = i2.targets.length; h2 < v2; h2++) {
						...
						(m2 = w.func(g2) ? g2(f2, d2, e2._proxy, p2, h2) : g2) && c2.push({
							x: (w.number(m2.x) ? m2.x : f2) + p2.x,
							y: (w.number(m2.y) ? m2.y : d2) + p2.y,
							range: w.number(m2.range) ? m2.range : i2.range,
							source: g2,
							index: h2,
							offset: p2
						});
					...
					for (var y2 = {
						...
						E2 === Infinity && y2.inRange && y2.range !== Infinity && (P2 = false), y2.target && !(P2 ? y2.inRange && E2 !== Infinity ? _2 / E2 < y2.distance / y2.range : E2 === Infinity && y2.range !== Infinity || _2 < y2.distance : !y2.inRange && _2 < y2.distance) || (y2.target = x2, y2.distance = _2, y2.range = E2, y2.inRange = P2, y2.delta.x = T2, y2.delta.y = S2);
					}
			...
			var jn = {
				start: function(t2) {
					...
					t2.state = { options: {
						...
						offset: r2.offset || "self",
						origin: {
							x: 0,
							y: 0
						},
						range: r2.range
					} }, e2.targetFields = e2.targetFields || [["width", "height"], ["x", "y"]], Rn.start(t2), e2.offsets = t2.state.offsets, t2.state = e2;
				},
				set: function(t2) {
					var e2 = t2.interaction, n2 = t2.state, r2 = t2.coords, i2 = n2.options, o2 = n2.offsets, a2 = {
						x: r2.x - o2[0].x,
						y: r2.y - o2[0].y
					};
			...
			var Xn = {
				...
				install: function(t2) {
					...
					for (var n2 in t2.usePlugin(Ee), t2.usePlugin(hn), e2.modifiers = Xn, Xn) {
						var r2 = Xn[n2], i2 = r2._defaults;
						i2._methods = r2._methods, t2.defaults.perAction[n2] = i2;
					}
				}
			}, qn = (function(t2) {
				s(n2, t2);
				...
				listeners: {
					...
					"interactions:move": function(t2, e2) {
						var n2 = t2.interaction, r2 = t2.pointer, i2 = t2.event, o2 = t2.eventTarget;
						t2.duplicate || n2.pointerIsDown && !n2.pointerWasMoved || (n2.pointerIsDown && Gn(t2), Vn({
							interaction: n2,
							pointer: r2,
							event: i2,
							eventTarget: o2,
					...
					"interactions:down": function(t2, e2) {
						(function(t3, e3) {
							for (var n2 = t3.interaction, r2 = t3.pointer, i2 = t3.event, o2 = t3.eventTarget, a2 = t3.pointerIndex, s2 = n2.pointers[a2].hold, c2 = q(o2), l2 = {
								interaction: n2,
								pointer: r2,
								event: i2,
								eventTarget: o2,
								...
								path: c2,
								node: null
							}, u2 = 0; u2 < c2.length; u2++) l2.node = c2[u2], e3.fire("pointerEvents:collect-targets", l2);
							if (!l2.targets.length) return;
							for (var f2 = Infinity, d2 = 0, h2 = l2.targets; d2 < h2.length; d2++) {
			...
			function Wn(t2, e2) {
				...
				for (var l2 = q(o2), u2 = {
					...
					targets: [],
					node: null
				}, p2 = 0; p2 < l2.length; p2++) u2.node = l2[p2], e2.fire("pointerEvents:collect-targets", u2);
			...
			var Jn = {
				...
				listeners: {
					"pointerEvents:collect-targets": function(t2, e2) {
						...
						e2.interactables.forEachMatch(r2, (function(t3) {
							...
							e3.types[i2] && e3.types[i2].length && t3.testIgnoreAllow(a2, r2, o2) && n2.push({
								node: r2,
								eventable: e3,
								props: { interactable: t3 }
							});
						}));
					},
							...
							for (var r2 = t3.getAllElements(), i2 = n2.window.Promise, o2 = i2 ? [] : null, a2 = function() {
								...
								if (u2) u2.move(), o2 && (l2 = u2._reflowPromise || new i2((function(t4) {
									...
									l2 = (function(t4, e5, n3, r3, i3) {
										var o3 = t4.interactions.new({ pointerType: "reflow" }), a4 = {
											interaction: o3,
											event: i3,
											pointer: i3,
											eventTarget: n3,
										...
										var c3 = t4.window.Promise, l3 = c3 ? new c3((function(t5) {
									...
									})(n2, t3, a3, e4, /* @__PURE__ */ (function(t4) {
										return {
											coords: t4,
											get page() {
			...
			}), un.default = un, "object" === n(module) && module) try {
				module.exports = un;
			} catch (t2) {}
...
var interact = /* @__PURE__ */ getDefaultExportFromCjs(/* @__PURE__ */ requireInteract_min());
var useSizeOverride = (context) => makeController(() => {
	const applyAxis = (requestedSize, axis, el) => {
		if (requestedSize === void 0) return;
		...
		if (min !== null) clampedSize = Math.round(Math.max(clampedSize, min));
		if (max !== null) clampedSize = Math.round(Math.min(clampedSize, max));
		el.style.setProperty(prop, `${Math.round(clampedSize)}px`);
		return clampedSize;
	};
	return { resize(sizes) {
		let targetElement;
		if (typeof context.targetElement === "function") targetElement = context.targetElement()?.value ?? null;
		else if (context.targetElement && "value" in context.targetElement) targetElement = context.targetElement.value;
		else targetElement = context.targetElement;
		if (!targetElement) return {
			inline: void 0,
			block: void 0
		};
		return {
			inline: applyAxis(sizes.inline, "inline", targetElement),
			block: applyAxis(sizes.block, "block", targetElement)
		};
	} };
});
//#endregion
//#region node_modules/@esri/calcite-components/dist/chunks/usePreventDocumentScroll.js
...
var usePreventDocumentScroll = () => {
	...
	function removeOpenedComponent() {
		openedComponentCount--;
		if (openedComponentCount === 0) document.documentElement.style.overflow = initialDocumentOverflowStyle;
	}
	return makeGenericController((component, controller) => {
		controller.onConnected(() => {
			if (component.opened && component.preventDocumentScroll) addOpenedComponent();
		});
		controller.onUpdate((changes) => {
			if (!component.hasUpdated) return;
			if (changes.has("opened") && component.preventDocumentScroll) if (component.opened) addOpenedComponent();
			else removeOpenedComponent();
			else if (changes.has("preventDocumentScroll") && component.opened) if (component.preventDocumentScroll) addOpenedComponent();
			else removeOpenedComponent();
		});
		controller.onDisconnected(() => {
			if (component.opened && component.preventDocumentScroll) removeOpenedComponent();
		});
	});
};
//#endregion
export { interact as n, useSizeOverride as r, usePreventDocumentScroll as t };

//# sourceMappingURL=usePreventDocumentScroll-DlGhtaeA.js.map