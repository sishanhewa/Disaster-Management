//#region node_modules/@arcgis/core/chunks/qb3-wasm.js
var t, r = (t = "undefined" != typeof document ? document.currentScript?.src : void 0, async function(r = {}) {
	var e, n, i = r, a = new Promise((t, r) => {
		e = t, n = r;
	...
	var u, c, f = Object.assign({}, i), p = (t, r) => {
		throw r;
	}, h = "";
	function l(t) {
		return i.locateFile ? i.locateFile(t, h) : h + t;
	}
	(o || s) && (s ? h = self.location.href : "undefined" != typeof document && document.currentScript && (h = document.currentScript.src), t && (h = t), h = h.startsWith("blob:") ? "" : h.slice(0, h.replace(/[?#].*/, "").lastIndexOf("/") + 1), s && (c = (t) => {
	...
	var m, y, w, g, v, A = i.wasmBinary, b = !1;
	function R() {
		var t = m.buffer;
		i.HEAP8 = w = new Int8Array(t), i.HEAP16 = new Int16Array(t), i.HEAPU8 = g = new Uint8Array(t), i.HEAPU16 = new Uint16Array(t), i.HEAP32 = new Int32Array(t), i.HEAPU32 = v = new Uint32Array(t), i.HEAPF32 = new Float32Array(t), i.HEAPF64 = new Float64Array(t), i.HEAP64 = new BigInt64Array(t), i.HEAPU64 = new BigUint64Array(t);
	}
	function _() {
	...
	function H(t) {
		i.onAbort?.(t), d(t = "Aborted(" + t + ")"), b = !0, t += ". Build with -sASSERTIONS for more info.";
	...
	function C(t) {
		if (t == P && A) return new Uint8Array(A);
		if (c) return c(t);
	...
	async function k(t, r, e) {
		if (!t && "function" == typeof WebAssembly.instantiateStreaming) try {
	...
	async function M() {
		function t(t, r) {
			return pt = t.exports, m = pt.h, R(), T(), pt;
		}
		function r(r) {
			return t(r.instance);
		}
		x();
		var e = B();
		if (i.instantiateWasm) return new Promise((r, n) => {
			i.instantiateWasm(e, (e, n) => {
				t(e), r(e.exports);
			});
		});
		P ??= j();
		try {
			return r(await k(A, P, e));
		} catch (a) {
	...
	var O = (t) => {
	...
	}, $ = [], q = (t) => $.unshift(t), G = [], L = (t) => G.unshift(t), N = i.noExitRuntime || !0, z = "undefined" != typeof TextDecoder ? new TextDecoder() : void 0, X = (t, r = 0, e = NaN) => {
		for (var n = r + e, i = r; t[i] && !(i >= n);) ++i;
		if (i - r > 16 && t.buffer && z) return z.decode(t.subarray(r, i));
		for (var a = ""; r < i;) {
			var o = t[r++];
			if (128 & o) {
				var s = 63 & t[r++];
		...
		return a;
	}, J = (t, r) => t ? X(g, t, r) : "", K = (t, r, e, n) => H(`Assertion failed: ${J(t)}, at: ` + [
	...
	var V = 0, Y = {}, Z = (t) => {
		if (t instanceof D || "unwind" == t) return y;
		p(1, t);
	}, tt = () => N || V > 0, rt = (t) => {
		y = t, tt() || (i.onExit?.(t), b = !0), p(t, new D(t));
	}, et = (t, r) => {
		y = t, rt(t);
	}, nt = () => {
		if (!tt()) try {
	...
	}, at = () => performance.now(), ot = () => 2147483648, st = (t, r) => Math.ceil(t / r) * r, ut = (t) => {
		var r = (t - m.buffer.byteLength + 65535) / 65536 | 0;
		try {
			return m.grow(r), R(), 1;
		} catch (e) {}
	}, ct = (t, r) => {
		...
		d: (t, r) => {
			if (Y[t] && (clearTimeout(Y[t].id), delete Y[t]), !r) return 0;
			return Y[t] = {
				id: setTimeout(() => {
					delete Y[t], it(() => ht(t, at()));
				}, r),
				timeout_ms: r
			}, 0;
		},
		e: (t) => {
			...
			for (var n = 1; n <= 4; n *= 2) {
				...
				if (ut(Math.min(e, st(Math.max(t, i), 65536)))) return !0;
			}
			return !1;
		},
		b: rt
	...
	function lt() {
		function t() {
			i.calledRun = !0, b || (E(), e(i), i.onRuntimeInitialized?.(), S());
		}
		I > 0 ? U = lt : (_(), I > 0 ? U = lt : i.setStatus ? (i.setStatus("Running..."), setTimeout(() => {
			setTimeout(() => i.setStatus(""), 1), t();
		}, 1)) : t());
	}
...
//# sourceMappingURL=qb3-wasm-tSVPKRyq.js.map